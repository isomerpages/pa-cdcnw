...
<div style="width: 100%;">
  <img src="https://northwest.cdc.gov.sg/images/Cohesion/May%202023/uplifting-the-community.png" style="width: 100%; max-width:">
  <img src="/images/Cohesion/Sep%202023/uplifting-title.png" style="width: 100%; max-width:">
</div>

<div style="max-width: 100%; padding: 30px 0px 0px;" class="rounded20">
  <img src="/images/Cohesion/Sep%202023/uplifting-kv.jpg" class="rounded20" style="width: 100%; margin-top: 0px;">
</div>

<div style="padding: 0px 0px 0px;">
<p style="font-size: 16px; line-height: 26px; margin: 15px 0px;">Lifelong learner Jayanthi has always been enthusiastic about pursuing new skills and knowledge to develop herself professionally and personally. Thanks to various SkillsFuture courses, she has been able to expand her skillsets. Let’s find out more about her journey.</p> 
</div>

<div style="max-width: 100%; padding: 15px 0px;">
  <img src="/images/Cohesion/Sep%202023/uplifting-quote.png" class="" style="width: 100%; margin-top: 0px;">
</div>

<div style="max-width: 100%; padding: 30px 0px 0px;" class="rounded20">
  <img src="/images/Cohesion/Sep%202023/uplifting-infograhics.png" class="rounded20" style="width: 100%; margin-top: 0px;">
</div>

<div style="width: 100%; padding: 50px 0px 10px; text-align: center;">
  <img src="/images/Cohesion/Sep%202023/3-takeaways.png" style="width: 100%; max-width: 480px;">
</div>

<div style="width: 100%; background: #283F94; padding: 15px 0px; margin: 25px 0px; display: flex;" class="rounded20">
  <div style="padding: 20px 40px; color: #FFFFFF;">
        <ol>
          <li style="line-height: 24px; padding-bottom: 15px; padding-left: 15px; font-weight: bold; font-size: 20px;">Learning knows no boundaries: 
            <div style="font-weight: normal; font-size: 16px;">Regardless of age, background or profession, Learning is a Gift that is fulfilling and helps us&nbsp;to&nbsp;grow.</div> 
          </li>
          <li style="line-height: 24px; padding-bottom: 15px;  padding-left: 15px; font-weight: bold; font-size: 20px;">Stay relevant by continuously upgrading your skills: 
            <div style="font-weight: normal; font-size: 16px;">The world is constantly evolving. Take the initiative to learn new skills and step out of your comfort zone.</div> 
          </li>
          <li style="line-height: 24px;  padding-left: 15px; font-weight: bold; font-size: 20px;">Tap on SkillsFuture: 
            <div style="font-weight: normal; font-size: 16px;">Whether you’re looking to reskill or upskill, SkillsFuture has many resources, support, courses and platforms to help you chart your career path. Speak to a SkillsFuture Advisor and utilise your SkillsFuture Credits for your course! </div> 
          </li>
        </ol>
  </div>
</div>  
...
<div class="rounded20" style="width: 100%; background: #DFE2EF; padding: 10px 0px 0px;">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">

      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #283F94; margin: 0px 0px;">
        <strong>SkillsFuture Advice @ North West</strong>
      </p> 

        <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px;">Looking to secure a promotion, make a career switch or obtain a new position? SkillsFuture Advice @ North West has plenty of resources to help you acquire the skills and training you need to unlock your potential. Check it out <a href="https://northwest.cdc.gov.sg/programmes/uplifting-the-community/sfa-northwest/" target="_new" style="font-weight: bold; color: #283F94;">here</a>.  </p> 

        <br>

      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #283F94; margin: 0px 0px;">
        <strong>Save the date for the next Job Recruitment Fair in your neighbourhood!</strong>
      </p> 

        <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px;">Are you seeking new employment? Head on down to the SkillsFuture Advice @ North West Job Recruitment Fair on <strong>13 September 2023 (10:00am-4:00pm) at Yew Tee CC</strong>.</p> 
