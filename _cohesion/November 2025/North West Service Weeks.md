...
permalink: /cohesion/november-2025/nw-sw/
variant: markdown
description: ""
...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="/images/Cohesion/Nov%202025/title_service_weeks.png">
</div>

<div style="max-width: 100%; padding: 30px 0px 10px;" class="rounded20">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/Nov%202025/sw_masthead.gif">
</div>

<div style="padding: 10px 0px 0px;">
<p style="font-size: 16px; line-height: 26px;">In October, more than 110 teachers, parent volunteers and students from Northland Primary School showed up to bring joy and cheer to families living in public rental flats in Yishun.
<br><br>
They took over the pop-up market, assisting residents from public rental and local welfare schemes to customise their care packs of essential food and daily necessities. They also set up a Children’s Day carnival with game booths, a bouncy castle, and free snacks. Their efforts captured the joy and impact of lending a hand in the community.</p>
</div>


<div style="background: #FDC6C6; margin: 60px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 40px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <b style="font-weight: bold; color: #DA312C;">Care in a bag</b>
  </div>

  
</div>

<div style="max-width: 100%;padding: 30px 0px 10px;margin-top: -150px;" class="rounded20">
  <img style="width: 100%; max-width: 200px; margin: 0px 0px 10px; float: right;" class="rounded20" src="/images/Cohesion/Nov%202025/sw_logo.png">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/Nov%202025/care_in_bag.gif">
</div>



<div style="background: #FDC6C6; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 30px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <b style="font-weight: bold; color: #DA312C;">Kids rule the carnival</b>
  </div>
</div>

<div style="width: 100%; background: #FDEFEF; margin-top: -15px;" class="rounded20">
  <p style="font-size: 16px; line-height: 26px; padding: 30px 35px 0px;">The Children’s Day carnival was a hit with the kids! They ran from game to game and grabbed all their favourite snacks, making it a day full of smiles and laughter.</p>

  <img style="width: 100%; margin-top: 0px;" class="" src="/images/Cohesion/Nov%202025/top_games.png">

  <img style="width: 100%; margin-top: 0px; padding: 0px 0px 40px;" class="" src="/images/Cohesion/Nov%202025/bouncy_castle.png">
</div>


<div style="padding: 40px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <b style="color: #D5262B;">Giving back together</b>
  </p>
  <p style="font-size: 16px; line-height: 26px; margin-top: 5px;">Beyond the fun and laughter, that day also showed how meaningful volunteering can be when families do it side by side.</p>

  <img style="width: 100%; margin-top: 0px; padding: 10px 0px;" class="" src="/images/Cohesion/Nov%202025/quote_jestina.jpg">

  <img style="width: 100%; margin-top: 0px; padding: 10px 0px;" class="" src="/images/Cohesion/Nov%202025/quote_madam_chen.jpg">

  <p style="font-size: 16px; line-height: 26px; margin-top: 10px;">Catch <span style="font-weight: bold;">Northland Primary School's students and parents</span> bringing service and kindness to life in #OurNorthWest!</p>

</div>

<div style="width: 100%; padding: 10px 0px 10px; text-align: center; display: flex;">
  <div style="width:100%; text-align: center; margin: auto;">

<iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="476" width="267" src="https://www.facebook.com/plugins/video.php?height=476&amp;href=https%3A%2F%2Fwww.facebook.com%2Freel%2F25321083820817294%2F&amp;show_text=false&amp;width=267&amp;t=0"></iframe>
...
<div style="background: #DA312C; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <b style="font-weight: bold; color: #FFFFFF;">We want your ideas!</b>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  ...
  <div class="w-100">
    <p style="font-size: 16px; line-height: 26px; padding: 10px 5px 15px; margin: 0px 0px;">
      Inspired? If you’ve got a bright idea for a community project that can benefit local residents, we want to hear from you! With funding from the North West WeCare Fund, you can organise your own ground-up initiative too! Apply for the funding through this <a style="font-weight: bold; color: #D5262B;" target="_new" href="https://northwest.cdc.gov.sg/files/Application_Form___North_West_WeCare_Fund__FY24__Updated_June_.pdf">application form</a>, and email it to North West CDC at <a style="font-weight: bold; color: #D5262B;" target="_new" href="mailto:northwestcdc_partnerships@pa.gov.sg">northwestcdc_partnerships@pa.gov.sg</a>.
    </p>
    <br>
  </div>
  ...
  <div class="rounded20" style="max-width: 100%; background: #FDFDFE; padding: 10px 20px;">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #D5262B">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #D5262B; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/november-2024/wcf/"><span style="text-decoration: underline;">Discover How Northland Primary is Fostering a Culture of Giving</span>
      </a>
    </p>
  </div>
</div>
