...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202024/title_caring_sama.png">
</div>

<div style="max-width: 100%; padding: 30px 0px 10px;" class="rounded20">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/July%202024/kv_sama.jpg">
</div>
...
<div style="padding: 20px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <strong style="color: #D5262B;">Fast Facts about Project Sama Sama @ North West</strong>
  </p>
</div>
...
<div style="padding: 20px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <strong style="color: #D5262B;">What our residents say</strong>
  </p>
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/July%202024/mdm_noora_quote.jpg">
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/July%202024/mdm_yew_quote.jpg">
</div>

<div style="padding: 20px 0px 0px;">
<p style="font-size: 16px; line-height: 26px; font-weight: bold;">What do you plan to redeem? </p>
<p style="font-size: 16px; line-height: 26px;"><span style="font-size: 16px; line-height: 26px; font-weight: bold;">Mdm Noorasikin:</span> Food items such as noodles, bread and snacks for my kids. 
<br><br>
<span style="font-size: 16px; line-height: 26px; font-weight: bold;">Mdm Yew:</span> Food and drinks such as biscuits, bread, oats, coffee and Milo, as well as newspapers like Lianhe Zaobao and Shin Min Daily News. </p>
</div>

<div style="padding: 20px 0px 0px;">
<p style="font-size: 16px; line-height: 26px; font-weight: bold;">Do you have any items on your wish list? </p>
<p style="font-size: 16px; line-height: 26px;"><span style="font-size: 16px; line-height: 26px; font-weight: bold;">Mdm Noorasikin:</span> Next time, I plan to redeem other items like toothpaste or even the Berita Harian newspaper. 
<br><br>
<span style="font-size: 16px; line-height: 26px; font-weight: bold;">Mdm Yew:</span> Cereal and nuts would be good for staying healthy.</p>
</div>

<div style="padding: 20px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <strong style="color: #D5262B;">How to redeem</strong>
  </p>
</div>

<div style="max-width: 100%; padding: 30px 0px;">
  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/M4bnaWutwEU?si=HINmt8GdsbDtx1fU" height="315" width="560"></iframe>
  </div>
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/July%202024/edm_kv_sama2.png">
</div>


<p style="font-size: 16px; line-height: 26px;">Lend a helping hand to someone in need and be a part of this meaningful initiative!</p>
...
<div style="width: 100%; background: #F5E1E0; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #DA312C; margin: 0px 0px;"><strong>Be a Sponsor!</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">Be a part of this meaningful initiative! Join us by being a corporate or individual sponsor.<br> <br>
Contact <a style="font-weight: bold; color: #D5262B;" target="_new" href="mailto:haslank@sph.com.sg">haslank@sph.com.sg</a> for more details
<br><br>
Read more about Project Sama Sama @ North West <a style="font-weight: bold; color: #D5262B;" target="_new" href="https://northwest.cdc.gov.sg/programmes/caring/project-sama/">here</a>.
      </p> 
  </div>
</div>
</div>
