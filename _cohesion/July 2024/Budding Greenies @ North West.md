...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/July%202024/title_sustainable_preschooler.png">
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Early childhood is ideal for shaping children into eco-conscious individuals who can make a real impact to our environment. Through the Budding Greenies @ North West programme, preschoolers were engaged in green education and activities to instill a green mindset from young.
<br><br>
A group of K2 children from M.Y World @ Woodlands Preschool embarked on a project to raise awareness about preventing dengue through a  hand-drawn book and inspiring video. Proudly created and narrated by themselves, these efforts raise awareness for dengue prevention and encourage people to stay vilgilent in the community.
</p>
</div>

<div style="padding: 0px 0px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><strong>Watch the video now!</strong></p> 
</div>

<div style="max-width: 100%; padding: 30px 0px;">
  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/C5p_xNFw0mc?si=VtNCgfrfOSxZxGEQ" height="315" width="560"></iframe>
  </div>
</div>

<div style="padding: 0px 0px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #000000; margin: 0px 0px;"><strong>Let’s go behind the scenes and explore their journey!</strong></p> 
</div>


<div class="" style="max-width: 100%; padding: 30px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/July%202024/preschooler_infographics_01.gif">
</div>
<div class="" style="max-width: 100%; padding: 0px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/July%202024/preschooler_infographics_02.gif">
</div>
<div class="" style="max-width: 100%; padding: 0px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/July%202024/preschooler_infographics_03.jpg">
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">This project is supported by the Budding Greenies @ North West programme. The active involvement of preschoolers in creating the dengue prevention book and video showcases the programme’s success in fostering environmental awareness and engagement among our young learners.</p>
</div>
...
<div style="padding: 0px 0px; text-align: right;">
  <img style="width: 100%; max-width: 130px; float: right; margin-top: -23px; margin-right: 12px;" src="/images/Cohesion/July%202024/greenie.png">
</div>
<div style="padding: 0px 0px;">
<div style="width: 100%; background: #DCEAE3; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 40px 40px;">
    <div style="padding: 0px 0px;">
      ...
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px; border-bottom: 2px solid #086B37;"><strong style="color: #086B37;">About Budding Greenies @ North West</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">Budding Greenies @ North West supports preschool centers in creating Green Learning corners to educate preschoolers about environmental conservation and eco-friendly habits through play activities. Participating preschools receive resources and financial support to instil environmental awareness from a young age. 
      <br><br>
Preschools in the North West can apply to the Budding Greenies @ North West programme
for funding. For more information, visit <a style="font-weight: bold; color: #086B37;" target="_new" href="https://go.gov.sg/nw-budding-greenies">go.gov.sg/nw-budding-greenies</a>.
      </p> 
  </div>
  <div style="padding: 40px 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px; border-bottom: 2px solid #086B37;"><strong style="color: #086B37;">About the North West GIRAFFE Fund</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">The North West GIRAFFE Fund provides funding for ground-up environmental initiatives by schools and community organisations in the North West. To qualify for the fund, projects should promote environmental education and enhance community participation in environmental activities. Find out more <a style="font-weight: bold; color: #086B37;" target="_new" href="https://northwest.cdc.gov.sg/programmes/bonding-the-people/northwest-giraffe-fund/">here</a>.
      </p> 
  </div>
</div>
</div>
