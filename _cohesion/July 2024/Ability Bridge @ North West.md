...
<div style="width: 100%;">
  <img style="width: 100%; max-width:" src="https://northwest.cdc.gov.sg/images/Cohesion/May%202024/inclusive.png">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202024/title_inclusive_ability.png">
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/July%202024/kv_inclusive_gif.gif">
</div>

<div style="padding: 20px 0px 0px;">
<p style="font-size: 16px; line-height: 26px;">Ability Bridge @ North West is a volunteer-led initiative to promote inclusivity by reaching out to children with special needs and their caregivers.</p>

<p style="font-size: 16px; line-height: 26px;">Through funding from the North West WeCare Fund, Ability Bridge @ North West organised a respite programme for children with special needs and their families from Nee Soon Central Zone 5. Held at Nee Soon Central Community Club on 25 May 2024, the event featured interactive games and sensory play for the children, as well as self-care activities for their caregivers, offering much-needed respite and support within a nurturing environment.</p>
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; max-width:" class="" src="/images/Cohesion/July%202024/ability.jpg">
</div>

<div style="padding: 40px 0px 0px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #DA312C; margin: 0px 0px;">
    <strong>Meet Our Husband-and-Wife Volunteer Duo</strong>
  </p> 
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; max-width:" class="" src="/images/Cohesion/July%202024/volunteer_duo.jpg">
  <p style="width: 100%; text-align: center; padding: 10px 3rem; margin: 0px; line-height: normal;"><em>Ability Bridge @ North West Project Coordinators Ashokkumar Ramachandran and Santha Raman</em></p>
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; max-width:" class="" src="/images/Cohesion/July%202024/duo_quotes.jpg">
</div>
...
<div style="width: 100%; background: #F5E1E0; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #DA312C; margin: 0px 0px;"><strong>Get Involved</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">At North West CDC, we encourage individuals, organisations and schools to create ground-up initiatives to support the community. Through the North West WeCare Fund, we connect community networks, provide monetary support and extend project management advice to support ground-up initiatives.</p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">Do you have an idea for a ground-up initiative? To apply for funding to initiate projects within the community, fill in this <a style="font-weight: bold; color: #D5262B;" target="_new" href="https://northwest.cdc.gov.sg/files/Application_Form___North_West_WeCare_Fund__FY24__Updated_June_.pdf">application form</a>, and email North West CDC at <a style="font-weight: bold; color: #D5262B;" target="_new" href="northwestcdc_partnerships@pa.gov.sg">northwestcdc_partnerships@pa.gov.sg</a> for further discussion.</p> 
  </div>
</div>
</div>
</div>
