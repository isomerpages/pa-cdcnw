...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/title_grab_meals.jpg">
</div>

<div style="width: 100%; padding: 20px 0px 0px !important;">
  <img class="rounded20" style="width: 100%; max-width:" src="/images/Cohesion/July%202026/kv_ready_meal.gif">
</div>


<div style="padding: 20px 0px !important;">
<p class="paragraph-article">With the rising cost of living, many of you may be paying closer attention to where your money goes especially when it comes to food. Ready Meals @ North West is here to make it easier and more convenient for residents to enjoy a quick meal at affordable prices.</p>

<p class="paragraph-article">Through this new initiative, you won't have to pay more than $3 for each meal! Available at vending machines located across the North West, residents will have more food options 24/7.</p>
</div>

<div style="width: 100%; padding: 25px 0px; text-align: center;">
  <iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="476" width="267" src="https://www.facebook.com/plugins/video.php?height=476&amp;href=https%3A%2F%2Fwww.facebook.com%2Freel%2F1546624220278578%2F&amp;show_text=false&amp;width=267&amp;t=0"></iframe>
</div>


<div style="width: 100%; padding: 15px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/ready_meals_1.jpg">
</div>

<div style="width: 100%; padding: 15px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/ready_meals_2.jpg">
</div>

<div style="width: 100%; padding: 15px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/top_menu_choices.jpg">
</div>

<div style="width: 100%; padding: 15px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/meal_locations.jpg">
</div>




<div style="padding: 20px 30px 20px; background: #F5E1E0; -webkit-border-bottom-right-radius: 20px; -webkit-border-bottom-left-radius: 20px; -moz-border-radius-bottomright: 20px; -moz-border-radius-bottomleft: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px;" class="rounded20">

  <div class="w-100">
    <p style="font-size: 16px; line-height: 26px; padding: 10px 5px 0px; margin: 0px 0px;">
      Find out more about Ready Meals @ North West <a style="font-weight: bold; color: #D5262B;" target="_new" href="https://northwest.cdc.gov.sg/ready-meals-north-west/">here</a>.</p>
