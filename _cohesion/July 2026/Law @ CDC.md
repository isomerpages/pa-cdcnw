---
title: Law @ CDC
permalink: /cohesion/july-2026/law-cdc/
variant: markdown
description: ""
...
<div style="width: 100%;">
  <img style="width: 100%; max-width:" src="https://northwest.cdc.gov.sg/images/Cohesion/January%202024/learning_communities.png">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/title_bridging_law.jpg">
</div>

<div style="width: 100%; padding: 20px 0px 0px !important;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/July%202026/law_cdc_kv.gif">
</div>


<div style="padding: 20px 0px !important;">
<p class="paragraph-article">Have you heard about LAW@CDC? Short for Law Awareness Weeks @ CDC, this initiative helps to make legal knowledge accessible, relevant, and easier to understand for the community.</p>
<br>
<p style="background: #1F4D7F; color: #FFFFFF; text-transform: uppercase; display: inline; font-weight: bold; padding: 4px 10px; font-size: small;" class="">What</p>
<p class="paragraph-article">Think of it as part of a social innovation lab! This is where participants work in teams to better understand the needs of the community so they can come up with ideas to make legal knowledge more accessible in everyday life. </p><br>

<p style="background: #1F4D7F; color: #FFFFFF; text-transform: uppercase; display: inline; font-weight: bold; padding: 4px 10px; font-size: small;" class="">Why</p>
<p class="paragraph-article">The goal is to help vulnerable individuals understand and apply their legal rights with greater confidence and awareness. Legal knowledge can also help these individuals from unknowingly committing offenses or being exploited. </p><br>

<p style="background: #1F4D7F; color: #FFFFFF; text-transform: uppercase; display: inline; font-weight: bold; padding: 4px 10px; font-size: small;" class="">How</p>
<p class="paragraph-article">To kickstart the process, participants embarked on an insightful learning journey to various social service agencies in the North West to better understand the legal issues faced by the community and find out where gaps exist in legal awareness.</p>
</div>


<div style="width: 100%; padding: 0px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/law_infographics_01.jpg">
</div>

<div style="width: 100%; padding: 0px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/law_infographics_02.gif">
</div>

<div style="width: 100%; padding: 0px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/law_infographics_03.jpg">
</div>

<div style="width: 100%; padding: 0px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/law_infographics_04.gif">
</div>

<div style="width: 100%; padding: 0px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/law_infographics_05.jpg">
</div>

<div style="width: 100%; padding: 0px 0px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/law_infographics_06.gif">
</div>

<div style="width: 100%; padding: 0px 0px 15px;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/July%202026/law_infographics_07.jpg">
</div>
...
<div style="background: #1F4D7F; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <b style="font-weight: bold; color: #FFFFFF;">About LAW @ CDC</b>
  </div>
</div>

<div style="padding: 20px 30px 20px; background: #E3F1FF; -webkit-border-bottom-right-radius: 20px; -webkit-border-bottom-left-radius: 20px; -moz-border-radius-bottomright: 20px; -moz-border-radius-bottomleft: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px;">

  <div class="w-100">
    <p style="font-size: 16px; line-height: 26px; padding: 10px 5px 0px; margin: 0px 0px;">
      Law Awareness Weeks @ CDC (LAW@CDC) promotes awareness and understanding of the law through a series of talks in the community. Orgnanised by the CDCs, these talks are designed for those without legal knowledge and distil complex legal jargon into easy to understand language so residents can better navigate legal issues. 
<br><br>
Find out more <a style="font-weight: bold; color: #1F4D7F;" target="_new" href="#">here</a>.</p>
