---
title: North West Sustainability Market
permalink: /cohesion/july-2026/sus-market/
variant: markdown
description: ""
...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/July%202026/title_fresh_finds.jpg">
</div>

<div style="padding: 0px 0px;">
  <p class="paragraph-article">Eat healthier and waste less! That was the message at the 2-day North West Sustainability Market held in June 2026.</p> 

<p class="paragraph-article">One of the highlights of the event was the Farmers' Market, which gave local farmers the chance to showcase their freshest produce and connect with the community. A hit with visitors, the Farmers' Market showed that buying local can be accessible and affordable!</p>
</div>

<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/July%202026/meet_local_farmers.jpg">
</div>

<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/July%202026/4_reasons.jpg">
</div>

<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/July%202026/4sustainable.gif">
</div>

<div class="" style="max-width: 100%; padding: 15px 0px; text-align: center;">
  <iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="476" width="267" src="https://www.facebook.com/plugins/video.php?height=476&amp;href=https%3A%2F%2Fwww.facebook.com%2Freel%2F1540997220743354%2F&amp;show_text=false&amp;width=267&amp;t=0"></iframe>
</div>
...
<div style="background: #196C37; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Embrace Green Living</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  ...
  <p class="paragraph-article">Feeling inspired to live green? Embark on your journey towards a sustainable lifestyle by participating in our <a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #196C37; text-decoration: underline;" href="https://northwest.cdc.gov.sg/programmes/bonding-the-people/greenhomes-at-northwest/"><span style="text-decoration: underline;">Green Homes @ North West</span></a> and <a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #196C37; text-decoration: underline;" href="https://northwest.cdc.gov.sg/programmes/bonding-the-people/reduce-at-northwest/"><span style="text-decoration: underline;">Reduce @ North West</span></a> programmes.<br><br></p>
  ...
  <div class="rounded20" style="max-width: 100%; background: #EAF3EE; padding: 10px 20px;">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #196C37; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/may-2026/reduce-nw/"><span style="text-decoration: underline;">Simple Ways to Save Energy</span>
      </a>
    </p>
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #196C37; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/november-2024/sust-fest/"><span style="text-decoration: underline;">5 Tips to Go Green at Home Starting with Food</span>
      </a>
    </p>
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #196C37; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/january-2024/nw-sustfest/"><span style="text-decoration: underline;">Making Greener Choices at the North West Sustainability Festival</span>
      </a>
    </p>
  </div>
