---
title: North West Walking Trails
permalink: /cohesion/may-2026/nw-wt/
variant: markdown
description: ""
...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/May%202026/title_walking_trails.jpg">
</div>
...
<div style="padding: 10px 0px 0px;">
  <p style="font-size: 28px; font-weight: bold; text-align: center; color: #F96B8D; margin: 0px 0px; line-height: initial;"><b>Walking Trails @ CDC (Heritage Edition)<br>
North West Trail: Woodlands</b>
  </p>
  <br>
  <p style="font-size: 20px; font-weight: bold; text-align: center; color: #000000; margin: 0px 0px;">Start: Woodlands North MRT Station<br> 
...
<p class="paragraph-article">Faith Hee and her mother, both members of the Petir NC Brisk Walking Club, completed 
Walking Trails @ CDC: Woodlands on 4 April 2026. Exploring the trail side by side, the mother-daughter walk was a healthy way to spend time together. It gave them the chance to bond while staying active.</p>
</div>
...
<div style="background: #E66776; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <b style="font-weight: bold; color: #FFFFFF;">Join North West Brisk Walking Club</b>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  ...
  <div class="rounded20" style="max-width: 100%; background: #FDFDFE; padding: 10px 20px;">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #F96B8D">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #F96B8D; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/march-2026/bwc-nw/"><span style="text-decoration: underline;">Discover the Top 3 Walking Trails in our North West</span>
      </a>
    </p>
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #F96B8D">
