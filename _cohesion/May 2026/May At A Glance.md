...
permalink: /cohesion/may-2026/may-at-a-glance/
variant: markdown
description: ""
...
<div style="margin: 30px 10px 0px; -webkit-border-radius: 35px; -moz-border-radius: 35px; border-radius: 35px;">
  ...
  <div style="width: 100%; border: 2px solid #F96B8D; webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px;" class="col-12">
...
<div style="width: 100%; display: inline-block;">
  ...
  <div style="max-width: 100%; padding: 10px 10px;">
    <div style="max-width: 100%; padding: 0px 0px 0px; background: #FFFFFF; margin: 30px 0px 0px; -webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px; border: 2px solid #7B669E;">
  <div style="width: 100%;">
...
<div style="width: 100%; display: inline-block;">
  ...
  <div class="col-6">
  <div style="max-width: 100%; padding: 10px 10px;">
    <div style="max-width: 100%; padding: 0px 0px 0px; background: #FFFFFF; margin: 30px 0px 0px; -webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px; border: 2px solid #F96B8D;">
  <div style="width: 100%;">
...
See who owned the moment!</p> 
  ...
  <div class="col-6">
  <div style="max-width: 100%; padding: 10px 10px;">
    <div style="max-width: 100%; padding: 0px 0px 0px; background: #FFFFFF; margin: 30px 0px 0px; -webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px; border: 2px solid #DA312C;">
  <div style="width: 100%;">
...
<div style="max-width: 100%; padding: 0px 0px;" class="col-12">
  <div style="background: #FFFFFF; margin: 30px 10px 0px; -webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px;">
    ...
    <div style="padding: 10px 20px 20px;">
      ...
      <div style="background: #FFFFFF; padding: 0px 0px 20px; margin-top: 10px; margin-bottom: 20px; display: inline-block;" class="w-100 rounded20">

      <div style="padding: 0px 0px 5px;" class="col-12 w-100">
      <div class="col-12 text-center">
        <div style="padding: 0px 0px 0px;">
          <img class="" style="width: 100%;" src="/images/Cohesion/May%202026/wu_hlf_1.jpg">
        </div>
      </div>
      ...
      <div class="col-12">
        <div style="padding: 20px 25px 0px; text-align: left;">
          ...
          <p style="font-size: 18px; color: #FE5D1F; font-weight: bolder; line-height: 22px; padding: 0px 0px; margin: 0px;">Where: Choa Chu Kang Stadium</p>
          <p style="font-size: 18px; color: #FE5D1F; font-weight: bolder; line-height: 22px; padding: 0px 0px; margin: 0px;">Entry is free!</p>
        </div>
      </div>
      ...
      <div style="width: 100%; max-width: 100%; text-align: center; padding: 10px 0px 20px; margin: auto;">
        <a href="#" target="_new" style="margin: auto; background: #FE5D1F; color: #FFFFFF; padding: 15px 25px; -webkit-border-radius: 50rem; -moz-border-radius: 50rem; border-radius: 50rem; font-size: 15px; font-family: Arial, 'sans-serif;'; text-decoration: none; text-transform: uppercase; min-width: 120px; font-style: italic; font-weight: bold; margin-top: 20px; margin-bottom: 10px; display: inline-block; text-align: center; font-style: italic;">Ready To Feel The Energy?</a>
      </div>

      <div style="padding: 0px 15px 5px;" class="col-12 w-100">
      <div class="col-3 text-center">
        <div style="padding: 20px 0px 0px;">
          <img style="max-width: 140px;" class="rounded20" src="/images/Cohesion/May%202026/wu_seasonpass.jpg">
        </div>
      </div>
      <div class="col-9">
...
<div style="background: #FFFFFF; padding: 20px 0px; margin-bottom: 10px; display: inline-block;" class="w-100 rounded20">
      ...
      <div class="col-12 text-center">
        <div style="padding: 20px 0px 0px;">
          <img class="" style="max-width: 200px;" src="/images/Cohesion/Mar%202026/NWCDC_logo.png">
        </div>
      </div>

      <div class="col-12">
        <div style="padding: 20px 1rem 0px; text-align: center;">
          ...
          <p style="font-size: 18px; line-height: 22px; padding: 12px 0px; margin: 0px;">Find job openings near you, get personalised career advice, and connect with employers!</p>
        </div>
      </div>
      ...
      <div style="padding: 10px 15px;">
        ...
        <table style="width: 100%; font-size: 14px;">
          ...
          <tr style="color: #000000; background: #FFFFFF; border-bottom: 1px solid #d6d6d6;">
            <td style="border-right: 1px solid #d6d6d6; border-bottom: 1px solid #d6d6d6; padding: 10px 10px;">Canberra CC, 2 Sembawang Crescent
      Yishun Green RN</td>

            <td style="border-right: 1px solid #d6d6d6; border-bottom: 1px solid #d6d6d6; padding: 10px 10px; text-align: center;">19 May 2026 (Tue)</td>
        ...
        <tr style="color: #000000; background: #FFFFFF; border-bottom: 1px solid #d6d6d6;">
            <td style="border-right: 1px solid #d6d6d6; border-bottom: 1px solid #d6d6d6; padding: 10px 10px;">Bukit Panjang CC, 8 Pending Rd</td>

            <td style="border-right: 1px solid #d6d6d6; border-bottom: 1px solid #d6d6d6; padding: 10px 10px; text-align: center;">20 May 2026 (Wed)</td>
          ...
          <tr style="color: #000000; background: #FFFFFF; border-bottom: 1px solid #d6d6d6;">
            <td style="border-right: 1px solid #d6d6d6; border-bottom: 1px solid #d6d6d6; padding: 10px 10px;">356A Admiralty Drive #01-80</td>
...
Ulu Pandan CC, 170 Ghim Moh Rd</td>
       ...
       <p style="font-size: 13px; line-height: 22px; padding: 12px 0px; margin: 0px; font-style: italic;">*Refer to our <a style="color: #FB5C1F;" target="_new" href="https://northwest.cdc.gov.sg/jobs-nearby-cdc/">website</a> for the most updated schedule.</p>
...
<div style="width: 100%;">
    ...
    <div style="width: 100%; padding: 15px 10px; text-align: center;">
      ...
      <div class="w-100">
        <a href="https://www.facebook.com/nwcdc/" target="_new"><img src="https://northwest.cdc.gov.sg/images/Cohesion/May%202023/square-facebook-orange.png" style="width: 100%; padding: 5px 7px; max-width: 40px; display: inline-block;"></a>
        <a href="https://www.linkedin.com/company/north-west-community-development-council/posts/?feedView=all" target="_new"><img src="/images/Cohesion/January%202025/linkedin.png" style="width: 100%; padding: 5px 7px; max-width: 40px; display: inline-block;"></a>
        <a href="https://www.instagram.com/northwestcdc" target="_new"><img src="https://northwest.cdc.gov.sg/images/Cohesion/May%202023/square-instagram-orange.png" style="width: 100%; padding: 5px 7px; max-width: 40px; display: inline-block;"></a>
        <a href="https://t.me/northwestcdc" target="_new"><img src="https://northwest.cdc.gov.sg/images/Cohesion/May%202023/telegram-orange.png" style="width: 100%; padding: 5px 7px; max-width: 40px; display: inline-block;"></a>
        <a href="https://www.youtube.com/northwestcdc" target="_new"><img src="https://northwest.cdc.gov.sg/images/Cohesion/May%202023/square-youtube-orange.png" style="width: 100%; padding: 5px 7px; max-width: 40px; display: inline-block;"></a>
      </div>
    </div>
