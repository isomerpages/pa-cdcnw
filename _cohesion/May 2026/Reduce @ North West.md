...
permalink: /cohesion/may-2026/reduce-nw/
variant: markdown
description: ""
...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/May%202026/title_simple_ways.jpg">
</div>

<div style="padding: 0px 0px;">
  <p class="paragraph-article">Have you heard of the Reduce @ North West programme? It rewards residents with a $100 voucher for reducing energy or water consumption by at least 5% over four months. With the changing energy landscape, we should be more mindful on how we use energy.</p> 

<p class="paragraph-article">Zhou Huibin, a recent Reduce @ North West winner, shares the simple habits he adopts to cut down on energy. Be inspired by these practical ideas to achieve energy savings. </p>
</div>

<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202026/quote_zhou.jpg">
</div>

<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202026/everyday_tips.jpg">
</div>


<div style="padding: 10px 0px 15px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><b>Energy-Saving Bingo </b>
  </p> 
  <p class="paragraph-article">Check out how many of these energy-saving activities Huibin has done!</p>
</div>

<div class="" style="max-width: 100%; padding: 0px 0px 15px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202026/everyday_bingo.jpg">
</div>
...
<div style="background: #196C37; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Reduce and Save</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  ...
  <p class="paragraph-article">Do your bit for the environment by conserving energy and embracing green habits at home.</p>
  ...
  <div class="rounded20" style="max-width: 100%; background: #EAF3EE; padding: 10px 20px;">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #196C37; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/march-2026/nw-green-living/"><span style="text-decoration: underline;">Championing a Greener #OurNorthWest</span>
      </a>
    </p>
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
