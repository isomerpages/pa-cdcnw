...
<div style="width: 100%;">
  <img style="width: 100%; max-width:" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/caring_communities.png">
  <img style="width: 100%; max-width:" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/ilhan_title.png">
</div>

<div style="max-width: 100%; padding: 30px 0px 10px;" class="rounded20">
  <img style="width: 100%; max-width:" class="rounded20" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/uplift_kv_min.gif">
...
<p style="font-size: 16px; line-height: 26px;">From mastering the art of public speaking and boosting their self-confidence, to polishing social etiquette and learning about financial literacy, the North West Student Wise Enrichment Programme (SWEP) is all about helping students to develop life skills to complement what they learn in school.<br><br>

12-year-old Ilhan Shah from Naval Base Primary School shares his learning journey with the SWEP programme in&nbsp;2023.</p>
</div>

<div class="" style="max-width: 100%; padding: 30px 0px 20px;">
  <img style="width: 100%; margin-top: 0px;" class="" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/nw_swep.png">
</div>

<div class="" style="max-width: 100%; padding: 30px 0px 20px;">
  <img style="width: 100%; margin-top: 0px;" class="" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/unlocking.png">
</div>
...
<div style="width: 100%; background: #F5E1E0; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #DA312C; margin: 0px 0px;"><strong>About the North West Student Wise Enrichment Programme (SWEP)</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">SWEP was launched in 2014 to provide less privileged students with equal opportunities to excel and develop their individual talents through a series of workshops to develop skills in listening and communications, social etiquette, and public speaking. Find out more <a style="font-weight: bold; color: #D5262B;" target="_new" href="https://go.gov.sg/ssf-nw">here</a>.
      </p> 
  </div>
</div>
</div>
