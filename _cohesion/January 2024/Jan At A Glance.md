...
<div style="width: 100%;">
  <a href="https://northwest.cdc.gov.sg/cohesion/january-2024/at-a-glance/">
    <img style="width: 100%; max-width: 786px; position: relative; padding-left: 0px; float:left !important; padding-bottom: 0px; padding-left: 2px; float: left;" src="/images/Cohesion/January%202024/masthead_2024_min.gif">
  </a>
</div>
  ...
  <div style="margin: 30px 10px 0px; -webkit-border-radius: 35px; -moz-border-radius: 35px; border-radius: 35px;">
    <div style="width: 100%;">
      <img style="width: 100%; margin-top: 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px;-moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;" class="" src="/images/Cohesion/January%202024/edm_kv_swep.png">
    </div>
  ...
  <div style="background: #F8F8F8; padding: 30px 30px; -webkit-border-bottom-right-radius: 25px; -webkit-border-bottom-left-radius: 25px; -moz-border-radius-bottomright: 25px; -moz-border-radius-bottomleft: 25px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px;">
    <h2 style="color: #DA312C; font-weight: bold; font-size: x-large; text-align: center;">
      <strong><em>Ilhan's Journey of Personal Growth   </em></strong>
    </h2>
    <p style="font-size: 16px; line-height: 26px;">Ilhan Shah, Naval Base Primary School student, shares his learning journey with the North West Student Wise Enrichment programme where he learned useful life skills and developed his confidence while making new friends along the way.</p>
    <div style="max-width: 100%; text-align: center; padding: 30px 15px 15px;"><a style="background: #DA312C; color: #FFFFFF; padding: 15px 25px; -webkit-border-radius: 50rem; -moz-border-radius: 50rem; border-radius: 50rem; font-size: medium; font-family: Arial, 'sans-serif;'; text-decoration: none; text-transform: uppercase; min-width: 150px;" href="https://northwest.cdc.gov.sg/cohesion/january-2024/nw-swep/"><em>Read More</em></a></div>
  </div>
  </div>
...
<div style="width: 100%;">
  ...
  <div style="width: 100%;">
    <img style="width: 100%; margin-top: 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px;-moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;" class="" src="/images/Cohesion/January%202024/get_active_kv_edm.png">
  </div>
  <div style="background: #F8F8F8; padding: 30px 20px; -webkit-border-bottom-right-radius: 25px; -webkit-border-bottom-left-radius: 25px; -moz-border-radius-bottomright: 25px; -moz-border-radius-bottomleft: 25px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px; min-height: 340px; position: relative;">
    <h2 style="color: #F96B8D; font-weight: bold; font-size: x-large;">
      <strong style="color: #F96B8D;"><em>Embracing the Power of Fitness</em></strong>
    </h2>
    <p style="font-size: 16px; line-height: 26px;">It was a fitness extravaganza for our North West FitnessX Club members, as they came together to bond and keep fit! The participants work out to 4 different exercises, ranging from the high intensity CrossFit and Fight-Do, to the grooves of Zumba and K-Pop&nbsp;Fitness.
    </p> 

    <div style="width: 100%; text-align: center; display: inline-flex; margin: 0px auto;">
    <div style="max-width: 100%; text-align: center; padding: 15px 15px; margin: 0px auto;"><a style="background: #F96B8D; color: #FFFFFF; padding: 15px 25px; -webkit-border-radius: 50rem; -moz-border-radius: 50rem; border-radius: 50rem; font-size: medium; font-family: Arial, 'sans-serif;'; text-decoration: none; text-transform: uppercase; min-width: 150px;" href="https://northwest.cdc.gov.sg/cohesion/january-2024/nw-fitnessx/"><em>Check It Out</em></a>
    </div>
    </div>
  </div>
  </div>
  ...
  <div style="max-width: 100%; padding: 10px 10px;">
    <div style="max-width: 100%; padding: 0px 0px 0px; background: #FFFFFF; margin: 30px 0px 0px; -webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px;">
  <div style="width: 100%;">
    <img style="width: 100%; margin-top: 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px;-moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;" class="" src="/images/Cohesion/January%202024/youth_volunteers_kv_edm.png">
  </div>
  <div style="background: #F8F8F8; padding: 30px 20px; -webkit-border-bottom-right-radius: 25px; -webkit-border-bottom-left-radius: 25px; -moz-border-radius-bottomright: 25px; -moz-border-radius-bottomleft: 25px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px; min-height: 340px; position: relative;">
    <h2 style="color: #1F4D7F; font-weight: bold; font-size: x-large;">
      <strong style="color: #1F4D7F;"><em>Youth Volunteers Enriching Lives</em></strong>
    </h2>
    <p style="font-size: 16px; line-height: 26px;">Over 200 residents turned up at the YA Wellness &amp; Sustainability Day, participating in various activities to promote a healthier and greener lifestyle in the community.   
    </p> 

    <div style="width: 100%; text-align: center; display: inline-flex; margin: 0px auto;">
    <div style="max-width: 100%; text-align: center; padding: 65px 15px 15px; margin: 0px auto;"><a style="background: #1F4D7F; color: #FFFFFF; padding: 15px 25px; -webkit-border-radius: 50rem; -moz-border-radius: 50rem; border-radius: 50rem; font-size: medium; font-family: Arial, 'sans-serif;'; text-decoration: none; text-transform: uppercase; min-width: 150px;" href="https://northwest.cdc.gov.sg/cohesion/january-2024/nw-ya/"><em>Find Out More</em></a>
    </div>
    </div>
  </div>
  </div>
...
<div style="max-width: 100%; padding: 10px 0px;" class="col-12">
  <div style="background: #FFFFFF; margin: 30px 10px 0px; -webkit-border-radius: 35px; -moz-border-radius: 35px; border-radius: 35px;">
    <div style="width: 100%;">
      <img style="width: 100%; margin-top: 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px;-moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;" class="" src="/images/Cohesion/January%202024/green_kv_edm.png">
    </div>

  <div style="background: #F8F8F8; padding: 30px 30px; -webkit-border-bottom-right-radius: 25px; -webkit-border-bottom-left-radius: 25px; -moz-border-radius-bottomright: 25px; -moz-border-radius-bottomleft: 25px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px;">
    <h2 style="color: #086B37; font-weight: bold; font-size: x-large;">
      <strong style="color: #086B37;">Making Greener Choices at the North West Sustainability Festival </strong>
    </h2>
    <p style="font-size: 16px; line-height: 26px;">Meet our North West Green Champions! Cincelia Tan shares how table hydroponics can be used to grow veggies at home while Raymond Ang is determined to inspire more people to reduce food waste. Just like them, you too can embark on a journey towards a greener way of living.  </p>
    ...
    <div class="col-12 w-100">
      ...
      <div class="col-8">
        <div style="padding: 40px 2rem 20px;">
          <h2 style="color: #FE5D1F; margin-bottom: 0px; letter-spacing: 0px; font-size: x-large; line-height: 26px; font-weight: bold; font-family: Arial, 'sans-serif;'; margin: 0px;"><i>Running Clinic @ North West</i></h2>
          <h4 style="color: #FE5D1F; margin: 10px 0px; font-size: medium; font-weight: bold; font-family: Arial, 'sans-serif;'; font-style: italic;">20 Jan 2024 | 9am – 12:30pm (Registration starts 8.15am)<br>
Tzu Chi Humanistic Youth Centre</h4>
          <p style="font-size: 16px; line-height: 26px;">Whether you’re new to running or a seasoned runner, take this chance to find out how to improve your running performance in our informative workshop! Learn strength training, what types of nutrition to elevate your run, and pick up recovery tips to stay injury-free. Sign-up to receive an Under Armour T-shirt, and a chance to participate in a lucky draw!
</p>
    ...
    <div class="col-12 w-100">
      <div class="col-4 text-center">
        <div style="padding: 30px 20px 0px;">
          <img style="max-width: 120px;" src="/images/Cohesion/January%202024/read_win.png">
        </div>
      </div>
      <div class="col-8">
        <div style="padding: 40px 2rem 20px;">
...
Cohesion e-newsletters</p>
    ...
    <div class="col-12 w-100">
      <div class="col-4 text-center">
        <div style="padding: 30px 20px 0px;">
          <img style="max-width: 120px;" src="/images/Cohesion/January%202024/happening_january.png">
        </div>
      </div>
      <div class="col-8">
        <div style="padding: 40px 2rem 20px;">
          <h2 style="color: #FE5D1F; margin-bottom: 0px; letter-spacing: 0px; font-size: x-large; line-height: 26px; font-weight: bold; font-family: Arial, 'sans-serif;';"><i>What’s happening in January </i></h2>

          <p style="font-size: 16px; line-height: 26px;">We’re kicking off 2024 with an exciting line-up of activities for the North West community. Check out our social post for upcoming activities such as Running Clinic @ North West, Chinese New Year Light-up and more! Follow us on Facebook and Instagram to stay updated on more fun events happening in your neighbourhood! </p>
          <div style="max-width: 100%; text-align: left; padding: 30px 0px;">
            <a style="background: #FE5D1F; color: #FFFFFF; padding: 15px 25px; -webkit-border-radius: 50rem; -moz-border-radius: 50rem; border-radius: 50rem; font-size: medium; font-family: Arial, 'sans-serif;'; text-decoration: none; text-transform: uppercase; min-width: 150px; font-style: italic; font-weight: bold;" target="_new" href="https://www.facebook.com/nwcdc/posts/pfbid0DvTqL7kZJX4SZrM3KMFdo24eKAFfoVV38feQU8f9d5FovhbkXBtwUfMkFtdEdPPPl">
              <em>Discover More</em>
            </a>
          </div>
        </div>
