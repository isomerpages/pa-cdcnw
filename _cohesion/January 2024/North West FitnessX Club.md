...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/January%202024/embracing_fitness.png">
</div>
...
<div class="rounded20" style="max-width: 100%; padding: 30px 0px 0px;">
    ...
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" class="rounded20" src="https://www.youtube.com/embed/nT1BmnzmpZ4?version=3&amp;autoplay=1&amp;mute=1&amp;rel=0&amp;&amp;showinfo=0&amp;loop=1"></iframe>
  </div>
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">The North West FitnessX Club offers high-intensity workouts for members to keep fit and promote closer bonds within the community.
<br><br>
From the heart-pumping exercises of CrossFit and the martial arts action of Fight-Do to the cardio-rhythm fusion of Zumba and the energetic dance beats of K-pop Fitness, residents had a blast working out a sweat and trying out new moves at the FitnessX @ Sembawang Sports Fiesta. Let’s take a look at what went on!        
</p>
</div>

<div style="padding: 40px 0px 20px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong style="color: #F96B8D;">#CrossFitRevolution</strong>
  </p>
</div>

<div style="max-width: 100%;">
  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/UeZT7dUvwe4?si=vEoSdSiGeJDtDKIu" height="315" width="560"></iframe>
  </div>
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="/images/Cohesion/January%202024/crossfit_quote.png">
</div>

<div style="padding: 40px 0px 20px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong style="color: #F96B8D;">#FightDoTribe</strong>
  </p>
</div>

<div style="max-width: 100%;">
  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/SRFKI4fzhd0?si=1nzFMe8Dort74dyJ" height="315" width="560"></iframe>
  </div>
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="/images/Cohesion/January%202024/fightdo_quote.png">
</div>

<div style="padding: 40px 0px 20px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong style="color: #F96B8D;">#ZumbaVibes </strong>
  </p>
</div>

<div style="max-width: 100%;">
  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/R7rU4j1aBso?si=rFqKhAEnKgQiJtO5" height="315" width="560"></iframe>
  </div>
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="/images/Cohesion/January%202024/zumba_quote.png">
</div>


<div style="padding: 40px 0px 20px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong style="color: #F96B8D;">#KpopFitnessFun</strong>
  </p>
</div>

<div style="max-width: 100%;">
  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/0er6v4S6gS4" height="315" width="560"></iframe>
  </div>
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="/images/Cohesion/January%202024/kpop_quote.png">
</div>


<div style="padding: 50px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong style="color: #F96B8D;">Find your perfect workout</strong>
  </p>
  <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 10px 0px; margin: 0px;">Not sure which FitnessX class to join? Follow our simple guide to find the fitness class that’s right for you.          
</p>
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; padding: 0px 0px 50px;" class="rounded20" src="/images/Cohesion/January%202024/active_infographics.png">
</div>
...
<div style="width: 100%; background: #EBDFEC; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      ...
      <img style="width: 100%; max-width: 189px; padding-bottom: 25px; float: left;" src="/images/Cohesion/January%202024/nwfitness_logo.png">
      </div>

      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong>Join North West FitnessX Club</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">Embrace a healthier lifestyle by becoming a part of a vibrant fitness community. Join the FitnessX Club and  take that important step towards a fitter, happier you! Register <a style="font-weight: bold; color: #F96B8D;" target="_new" href="https://go.gov.sg/hlclub-interestform">now</a>.
      </p> 
  </div>
</div>
</div>
...
<div style="padding: 50px 15px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong>North West CDC Health and Fitness Habits Survey</strong>
  </p>
  <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 10px 0px;
    margin: 0px;">Take a moment to share more about your health and fitness lifestyle to shape community programmes in the North West District. You could be among 30 lucky winners to walk away with $30 shopping e-vouchers!          
  </p>
  <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 10px 0px;
    margin: 0px;">Complete the survey <a style="font-weight: bold; color: #F96B8D;" target="_new" href="https://go.gov.sg/nwcdchlsurvey24">here</a>.</p>
</div>
