...
<div style="width: 100%;">
  <img style="width: 100%;" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/sustainable_communities.png">
  <img style="width: 100%;" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/greener_choices.png">
</div>
...
<div class="rounded20" style="max-width: 100%; padding: 30px 0px 0px;">
    ...
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" class="rounded20" src="https://www.youtube.com/embed/rjASOsbMMWY?version=3&amp;autoplay=1&amp;mute=1&amp;rel=0&amp;&amp;showinfo=0&amp;loop=1"></iframe>
  </div>
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">The  first-ever  North  West  Sustainability  Festival was a vibrant showcase of green activities and workshops, 
aimed  at  educating  residents  on  green  living.  Residents  got  to interact with different features at the Green Homes exhibition and gained eco-friendly tips to help them make greener choices at home. Let’s find out more from two passionate individuals who have been championing green causes in the North West!    
</p>
</div>

<div style="padding: 20px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><strong>Meet our passionate Green Champions! </strong>
  </p>
</div>


<div style="max-width: 100%;">
  <img style="width: 100%;" class="rounded20" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/meet_green_champion.png">
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/cincella_tips.png">
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/meet_green_champion_2.png">
</div>

<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/raymond_tips.png">
</div>


<div style="padding: 20px 0px; text-align: center; margin: 50px auto 20px; width: 100%;">
  <div style="margin: 0px auto;">
<iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="710" width="500" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fnwcdc%2Fposts%2Fpfbid037D8AeWqyvU6CgYyBAL6etSvynkFBhB3jm2KSUvFEQrthutQuBVbuJmS6Nmv7JJEBl&amp;show_text=true&amp;width=500"></iframe>
  </div>
</div>
...
<div style="width: 100%; background: #DCEAE3; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      ...
      <img style="width: 100%; max-width: 137px; margin: 0px 0px 10px -15px;" src="https://staging.d2pf4p43lgd5yo.amplifyapp.com/images/Cohesion/January%202024/greenie_logo.png">

      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><strong>Embrace Green Living</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">Feeling inspired? Kick off the new year by championing eco-friendly practices in your community. Embark on your journey towards a sustainable lifesyle by participating in our <a style="font-weight: bold; color: #086B37;" target="_new" href="https://go.gov.sg/nw-greenhomes">Green Homes @ North West</a> and <a style="font-weight: bold; color: #086B37;" target="_new" href="https://go.gov.sg/nw-reduce">Reduce @ North West</a> programmes.
      </p> 
  </div>
</div>
</div>
