...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/November%202024/title_4_learning_tools.png">
</div>

<div style="width: 100%; padding: 20px 0px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Ready to boost your leadership skills? If you volunteer in the community and want to make a bigger impact, these 4 bite-sized courses on the Career Grit portal are just what you need! Plus, you don't have to spend hours in the classroom.
</p>
</div>

<div class="" style="max-width: 100%; padding: 10px 0px; display: inline-block;">
  <div class="col-6 float-left">
    <img style="width: 100%; padding: 10px 0px;" src="/images/Cohesion/November%202024/course1.png">
  </div>
  <div class="col-6 float-left">
    <img style="width: 100%; padding: 10px 0px;" src="/images/Cohesion/November%202024/course2.png">
  </div>
</div>
<div class="" style="max-width: 100%; padding: 10px 0px; display: inline-block;">
  <div class="col-6 float-left">
    <img style="width: 100%; padding: 10px 0px;" src="/images/Cohesion/November%202024/course3.png">
  </div>
  <div class="col-6 float-left">
    <img style="width: 100%; padding: 10px 0px;" src="/images/Cohesion/November%202024/course4.png">
  </div>
</div>


<div class="" style="max-width: 100%; padding: 2px 25px; background: #1F4D7F; -webkit-border-top-left-radius: 20px; -webkit-border-top-right-radius: 20px; -moz-border-radius-topleft: 20px; -moz-border-radius-topright: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; color: #FFFFFF;">
  <p style="font-size: 20px; line-height: 26px; text-align: justify; font-weight: bold;">Register to learn these courses in 4 easy steps:</p>
</div>


<div style="max-width: 100%; padding: 10px 25px 20px; background: #F7F7F7; -webkit-border-bottom-right-radius: 20px; -webkit-border-bottom-left-radius: 20px; -moz-border-radius-bottomright: 20px; -moz-border-radius-bottomleft: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px;">

  <p style="font-size: 16px; line-height: 26px; text-align: justify; font-weight: bold;">1. Visit <a style="font-weight: bold; color: #1F4D7F;" target="_new" href="https://careergrit.sg">www.careergrit.sg</a>
  </p>

  <a style="" target="new" href="https://go.gov.sg/greenhomesnw"><img style="width: 100%;" class="" src="/images/Cohesion/November%202024/screen1.jpg"></a>

  <p style="font-size: 16px; line-height: 26px; text-align: justify; font-weight: bold;">2. Click on 'Learning On-The-Go' and select 'Micro-Learning Courses' from the dropdown</p>

  <img style="width: 100%;" class="" src="/images/Cohesion/November%202024/screen2.jpg">

  <p style="font-size: 16px; line-height: 26px; text-align: justify; font-weight: bold;">3. Enter the name of your course in the search bar <br>
  <em style="font-weight: normal;">e.g. Resolve Conflicts Effectively</em></p>

  <img style="width: 100%;" class="" src="/images/Cohesion/November%202024/screen3.jpg">

  <p style="font-size: 16px; line-height: 26px; text-align: justify; font-weight: bold;">4. Hit the search button to find your course</p>
</div>
