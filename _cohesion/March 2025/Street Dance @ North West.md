...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" alt="Street Dance Battle: Bringing the Power of Dance to the Community" src="/images/Cohesion/March%202025/title_streetdance.png">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%;" class="rounded20" src="/images/Cohesion/March%202025/kv_streetdance.gif">
</div>
...
<br><br>
Over 100 dancers competed in an open style street dance battle, where they must react to a randomly played song - demonstrating their ability to improvise, think on their feet and truly express their individuality through dance.</p>
</div>

<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/streetdance_img_01.jpg">
</div>

<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/streetdance_img_02.gif">
</div>

<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/streetdance_img_03.gif">
</div>

<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/streetdance_img_04.jpg">
</div>

<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/streetdance_img_05.gif">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/streetdance_qa.png">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
<p style="font-size: 24px; font-weight: bold; text-align: left; color: #FF5C83; margin: 10px 0px;">Catch more highlights from Street Dance @ North West!</p>
</div>


<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/video_bg_01.jpg">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px; background: url('/images/Cohesion/March%202025/video_bg_02.jpg') repeat fixed center; text-align:center;">


  <div style="padding: 0px 10px;" class="iframe-wrapper">
    <iframe src="https://www.youtube.com/embed/xSYP0QhheU0" frameborder="0" allowfullscreen="true" height="711" width="400"></iframe>
  </div>


</div>

<div class="" style="max-width: 100%; padding: 0px 0px 20px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/video_bg_03.jpg">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202025/4_ways.png">
</div>
...
<div style="background: #F96B8D; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Keep the groove going!</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  <div class="w-100">
    ...
    <p style="font-size: 16px; line-height: 26px; padding: 10px 5px; margin: 0px 0px;">Feeling inspired? Join a community dance club today and keep the energy alive! Here are 3 dance-related Healthy Living Clubs in the North West just for you!
    </p>


    <div style="width: 100%; display: flex; border-bottom: thin solid #acacac; padding: 0px 0px 25px;" class="col-12">
      <div style="margin: auto;" class="col-3 float-left">
      ...
      <div style="margin: auto;" class="col-9 float-left">
        <p style="font-size: 16px; line-height: 20px; margin: 0px;">Best For:  Those who love simple dance routines and nostalgic tunes</p>
      </div>
    </div>

    <div style="width: 100%; display: flex; border-bottom: thin solid #acacac; padding: 25px 0px;" class="col-12">
      <div style="margin: auto;" class="col-3 float-left">
        <img style="max-width: 110px; width: 100%; padding: 10px 20px; vertical-align: middle;" src="/images/Cohesion/March%202025/logo_fitnessx.png">
      </div>
      <div style="margin: auto;" class="col-9 float-left"><p style="font-weight: bold; font-size: 18px; line-height: 20px; margin: 0px; width: 100%;">K-Pop Fitness</p>
        <p style="font-size: 16px; line-height: 20px; margin: 0px;">Best for: Those who love the youthful and energetic vibe of K-pop</p><br>
        <p style="font-weight: bold; font-size: 18px; line-height: 20px; margin: 0px; width: 100%;">Zumba</p>
        <p style="font-size: 16px; line-height: 20px; margin: 0px;">Best for: Those who love an energetic dance workout that blends Latin and international rhythms</p>
      </div>
    </div>

    <p style="font-size: 16px; line-height: 26px; padding: 20px 5px; margin: 0px 0px;">
      Register your interest <a style="font-weight: bold; color: #F96B8D; text-decoration: underline;" target="_new" href="https:/go.gov.sg/hlclub-interestform">here</a>.
    </p>
