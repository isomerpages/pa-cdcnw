...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/Mar%202026/title_ready_to_work_again.jpg">
</div>


<div style="max-width: 100%; padding: 20px 0px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Ready to work again but not sure where to start? Whether you are a caregiver looking for flexible jobs, switching careers or taking it slow after retirement, Jobs Nearby @ CDC is here to help you figure out your next steps!
<br><br>
Not only does Jobs Nearby @ CDC make it easier for jobseekers to find roles close to home, employers can also find candidates with the right skills for their needs. 
</p>
</div>

<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/Mar%202026/learning_infographics.jpg">
</div>

<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="rounded20" src="/images/Cohesion/Mar%202026/learning_table.jpg">
</div>

<div style="width: 100%; padding: 35px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <b style="color: #1F4D7F;">Job Ambassador Ron Ng's Tips</b>
  </p>
</div>

<div style="width: 100%; padding: 20px 0px 20px; text-align: center; display: flex;">
  <div style="width:100%; text-align: center; margin: auto;">
<iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="626" width="500" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fnwcdc%2Fposts%2Fpfbid02z7JfjNiqCYwEkefF5MUdXn8VF4c6Q7U74ZGRGbDt3dQyLmpYP8euAq8GSxuzcJdml&amp;show_text=true&amp;width=500"></iframe>
  </div>
</div>
...
<div style="width: 100%;  background: #1F4D7F; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="width: 100%; text-align: left; display: flex; margin: 0px auto; padding: 20px 0px 18px 35px; color: #FFFFFF; font-family: Arial, 'sans-serif;';">
          ...
          <b style="font-weight: bold; color: #FFFFFF; font-size: 20px;">Get Support at Jobs Nearby @ CDC</b>
          </p>
  </div>
</div>
...
<p style="font-size: 16px; line-height: 22px; padding: 10px 5px 15px; margin: 0px 0px;">
  Visit Community Job Clinics in the North West to speak to our Job Ambassadors and find out available roles near you. Register <a style="color: #1F4D7F; font-weight: bold; text-decoration: underline;" target="_new" href="https://go.gov.sg/nw-jobclinics">here</a>.
</p>
  ...
  <div class="rounded20" style="max-width: 100%; background: #FDFDFE; padding: 10px 20px; margin-top: 20px;">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #1F4D7F">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #1F4D7F; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/november-2025/jobs-nearby/"><span style="text-decoration: underline;">Find a Job Close to Home with Jobs Nearby @ CDC</span>
      </a>
    </p>
        <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #1F4D7F">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #1F4D7F; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/september-2025/jobs-anywhere/"><span style="text-decoration: underline;">Bringing Jobs Closer to You</span>
      </a>
    </p>
  </div>
