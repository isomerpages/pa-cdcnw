...
permalink: /cohesion/march-2026/nw-green-living/
variant: markdown
description: ""
...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/Mar%202026/title_championing.jpg">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/Mar%202026/quote_dennis_chee.jpg">
</div>

<div style="padding: 10px 0px 15px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><b>Making green living practical</b>
  </p> 
  <p style="font-size: 16px; line-height: 26px; text-align: justify; margin: 10px 0px;">Dennis takes the lead in promoting environmental ownership in #OurNorthWest  community, from cutting energy use to adopting green living habits.</p>
</div>

<div style="padding: 10px 0px 15px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><b>How he became a Green Champion</b>
  </p> 
  <p style="font-size: 16px; line-height: 26px; text-align: justify; margin: 10px 0px;">When I first joined the North West CDC, I volunteered to serve in the Green Living Standing Committee because I believe we’re all closely connected and have a shared responsibility to build a sustainable and vibrant community for generations to come.
  <br><br>
  At the ground level and as part of the committee, I helped to shape our sustainability initiatives. Our sustainability programmes have been recognised for their holistic and comprehensive approach at the annual Clean and Green Singapore challenge.</p>
</div>
...
<div class="col-12" style="padding: 20px 0px;">
      <div class="col-6" style="display: flex;">
        ...
        <div class="rounded20" style="width: 100%; background: #D3EBE5;">
          ...
          <p style="font-size: 16px;line-height: 20px;padding: 10px 0px 18px;margin: 0px 0px;min-height: 110px;">Schools, community groups and corporates came together in a 3-day festival focused on food sustainability.</p>
              
              <div style="font-size: 16px;line-height: 20px;margin: 10px 0px;padding: 10px 0px;"><img src="/images/Cohesion/Mar%202026/icon_nwsf1.png" class="" style="width: 100%; max-width: 36px; margin-top: -8px;" align="left">&nbsp;6,750 participants</div>
              <div style="font-size: 16px;line-height: 20px;margin: 10px 0px;padding: 10px 0px;"><img src="/images/Cohesion/Mar%202026/icon_nwsf2.png" class="" style="width: 100%; max-width: 36px; margin-top: -8px;" align="left">&nbsp;116 vlounteers</div>
              <div style="font-size: 16px;line-height: 20px;margin: 10px 0px;padding: 10px 0px;"><img src="/images/Cohesion/Mar%202026/icon_nwsf3.png" class="" style="width: 100%;max-width: 36px;margin-top: -8px;" align="left">&nbsp;24 partners</div>
            </div>        
          </div>
        </div>
        </div>
      ...
      <div class="col-6" style="display: flex;">
        ...
        <div class="rounded20" style="width: 100%; background: #D3EBE5;">
          ...
          <p style="font-size: 16px;line-height: 20px;padding: 10px 0px 18px;margin: 0px 0px;min-height: 110px;">Recycling points were set up in schools where students could deposit recyclables, learn about recycling processes, and engage in hands-on sustainability activities </p>

              <div style="font-size: 16px;line-height: 20px;margin: 10px 0px;padding: 10px 0px;"><img src="/images/Cohesion/Mar%202026/icon_recycle1.png" class="" style="width: 100%;max-width: 36px;margin-top: -8px;" align="left">&nbsp;55 schools</div>
              <div style="font-size: 16px;line-height: 20px;margin: 10px 0px;padding: 10px 0px;"><img src="/images/Cohesion/Mar%202026/icon_recycle2.png" class="" style="width: 100%;max-width: 36px;margin-top: -8px;" align="left">&nbsp;63,581 students</div>
              <div style="font-size: 16px;line-height: 20px;margin: 10px 0px;padding: 10px 0px;"><img src="/images/Cohesion/Mar%202026/icon_recycle3.png" class="" style="width: 100%;max-width: 36px;margin-top: -8px;" align="left">&nbsp;119,304 kg of recyclables collected</div>
            </div>        
          </div>
        </div>
        </div>
...
<div class="" style="max-width: 100%; padding: 20px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/Mar%202026/quote_green.png">
</div>


<div style="padding: 10px 0px 15px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><b>Green Living Bingo</b>
  </p> 
  <p style="font-size: 16px; line-height: 26px; text-align: justify; margin: 10px 0px;">Check out how many of these eco-friendly habits Dennis has actually done!</p>

  <img style="width: 100%;" class="" src="/images/Cohesion/Mar%202026/green_bingo.png">
</div>
...
<div style="background: #196C37; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Be an Eco Champion!</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  ...
  <p style="font-size: 16px; line-height: 18px; padding: 10px 0px; margin: 0px 0px;">
      Ready to live more sustainably? Get involved in programmes designed to help you do just that! 
    </p>
  ...
  <div class="rounded20" style="max-width: 100%; background: #EAF3EE; padding: 10px 20px;">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #196C37; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/january-2026/nw-green-living/"><span style="text-decoration: underline;">Fight Climate Change and Save up to $1,000</span>
      </a>
    </p>
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #196C37">
