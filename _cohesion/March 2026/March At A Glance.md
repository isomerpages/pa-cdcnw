...
permalink: /cohesion/march-2026/mar-at-a-glance/
variant: markdown
description: ""
...
<div style="margin: 30px 10px 0px; -webkit-border-radius: 35px; -moz-border-radius: 35px; border-radius: 35px;">
    ...
    <div style="width: 100%;">
      <img style="width: 100%; margin-top: 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px;-moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;" class="" src="/images/Cohesion/Mar%202026/edm1.jpg">
    </div>
  ...
  <div style="background: #F8F8F8; padding: 30px 30px; -webkit-border-bottom-right-radius: 25px; -webkit-border-bottom-left-radius: 25px; -moz-border-radius-bottomright: 25px; -moz-border-radius-bottomleft: 25px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px;">
    <h2 style="color: #F96B8D; font-weight: bold; font-size: x-large; text-align: center; margin: 10px;">
      <em>5 Reasons to Sign Up For Street Dance @ North West</em>
    </h2>
...
Possible by a Giving Community
    ...
    <p style="font-size: 16px; line-height: 22px; margin: 10px 0px;">In #OurNorthWest, there are many ways support reaches those in need. From daily essentials to emergency relief support, your contribution, big or small, can help sustain the many programmes in the North West that provide ongoing assistance to those who need extra support.</p> 
...
28 Apr 2026 / Tuesday</td>
    ...
    <tr style="color: #000000; background: #FFFFFF; border-bottom: 1px solid #d6d6d6;">
      ...
      <td style="border-right: 1px solid #d6d6d6; border-bottom: 1px solid #d6d6d6; padding: 10px 10px; text-align: center;">26 Mar 2026 / Thursday<br>2 Apr 2026 / Thursday</td>
...
7 Apr 2026 / Tuesday</td>
 ...
 <p style="font-size: 13px; line-height: 22px; padding: 12px 0px; margin: 0px; font-style: italic;">*Refer to our <a style="color: #FB5C1F;" target="_new" href="https://northwest.cdc.gov.sg/jobs-nearby-cdc/">website</a> for the most updated schedule.</p>
      ...
      <div class="col-3 text-center">
        <div style="padding: 20px 0px 0px;">
          <img style="max-width: 140px;" class="rounded20" src="/images/Cohesion/Mar%202026/wu1.jpg">
        </div>
      </div>
      <div class="col-9">
        <div style="padding: 20px 2rem 10px;">
          <h2 style="color: #FE5D1F; font-weight: bolder; font-size: 20px;line-height: initial;font-style: italic; margin: 0px;"><i>North West FitnessX Club Zumba Sweat-Out Party</i></h2>

          <p style="font-size: 16px; line-height: 22px; padding: 12px 0px; margin: 0px;">Complete your FREE workout and refuel with a treat! Download the <span style="font-weight: bold; font-weight: 900;">shopFarEast</span> app and receive a $5 voucher with <span style="font-weight: bold; font-weight: 900;">&lt;WSQSFE&gt;</span>.
          <br><br>
<span style="font-weight: bold;">When:</span> Every Wednesday 7pm – 8pm till 25 Mar 2026<br>
<span style="font-weight: bold;">Where:</span> Woods Square Mall Tower 1<br>
<span style="font-weight: bold;">Level:</span> All fitness levels welcome! No experience needed!<br></p>
          <div style="max-width: 100%; text-align: left; padding: 10px 0px 0px;">
            <a href="https://go.gov.sg/woodsquarezumba" target="_new" style="background: #FE5D1F; color: #FFFFFF; padding: 15px 25px; -webkit-border-radius: 50rem; -moz-border-radius: 50rem; border-radius: 50rem; font-size: 15px; font-family: Arial, 'sans-serif;'; text-decoration: none; text-transform: uppercase; min-width: 120px; font-style: italic; font-weight: bold; margin-right: 8px; margin-bottom: 10px; display: inline-block; text-align: center; font-style: italic;">
              Register Now
            </a>
          </div> 
      ...
      <div class="col-3 text-center">
        <div style="padding: 20px 0px 0px;">
          <img style="max-width: 140px;" class="rounded20" src="/images/Cohesion/Mar%202026/wu2.jpg">
        </div>
      </div>
      <div class="col-9">
        <div style="padding: 20px 2rem 10px;">
          <h2 style="color: #FE5D1F; font-weight: bolder; font-size: 20px;line-height: initial;font-style: italic; margin: 0px;"><i>Street Dance @ North West </i></h2>

          <p style="font-size: 16px; line-height: 22px; padding: 12px 0px; margin: 0px;">Calling all street dancers! Bring your passion, energy and best moves to battle it out at the second edition of Street Dance @ North West! Let your skills take over in a 1v1 showdown or 2v2 crew battle.
          <br><br>
          <span style="font-weight: bold;">When:</span> 28 March 2026, 12pm – 8pm<br>
          <span style="font-weight: bold;">Where:</span> Bukit Panjang Plaza (Atrium)
          </p>
                    <div style="max-width: 100%; text-align: left; padding: 10px 0px 0px;">
      ...
      <div class="col-3 text-center">
        <div style="padding: 20px 0px 0px;">
          <img style="max-width: 140px;" class="rounded20" src="/images/Cohesion/Mar%202026/wu3.jpg">
        </div>
      </div>
      <div class="col-9">
        <div style="padding: 20px 2rem 10px;">
          <h2 style="color: #FE5D1F; font-weight: bolder; font-size: 20px;line-height: initial;font-style: italic; margin: 0px;"><i>Apply for the People’s Association (PA) Scholarship</i></h2>

          <p style="font-size: 16px; line-height: 22px; padding: 12px 0px; margin: 0px;">The PA Scholarship offers local and overseas undergraduate scholarships to outstanding students who are passionate about community growth and development. As a PA Scholar, you can look forward to meaningful career in fields such as youth, active ageing, sports, the arts, community leadership and more. Apply for the PA Scholarship 2026 and unlock your potential! 
<br><br>
Application period: Now to 31 March 2026<br>
Submit your application via <a style="color: #FB5C1F;" target="_new" href="https://brightsparks.com.sg/profile/PA/scholarship.php">BrightSparks</a><br>
Visit <a style="color: #FB5C1F;" target="_new" href="https://www.pa.gov.sg/careers/pa-scholarship/pa-scholarship/">PA Scholarship</a> for more information</p>
