...
permalink: /cohesion/march-2026/street-dance/
variant: markdown
description: ""
...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/Mar%202026/title_5_reasons.jpg">
</div>


<div style="padding: 10px 0px 15px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Street Dance @ North West is back for its second run on 28 March 2026! Think you've got the rhythm, mindset and energy to rule the dance floor? Join us for an exciting open style street dance battle where you'll have to serve your best moves to match whatever beat that drops! </p>
</div>

<div class="" style="max-width: 100%; padding: 10px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/Mar%202026/street_dance_poster.jpg">
</div>

<div style="padding: 35px 0px 0px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><b>Here are 5 reasons to join Street Dance @ North West </b>
  </p> 

  <p style="font-size: 16px; line-height: 26px; text-align: justify;"><span style="font-weight: bold;">1. Own the spotlight</span><br>
This is your moment to shine, where you'll step into the lights, feel the beat, and command the stage! 
Dancing builds confidence and helps you feel more comfortable in your own skin.<br><br>

<span style="font-weight: bold;">2. Open style = creative expression</span><br>
The music is a surprise, so you'll have to go with the vibe, feel the rhythm, and express yourself on the spot. Freestyling is a powerful way to let your creativity out while boosting those feel-good endorphins that lift your mood.<br><br>

<span style="font-weight: bold;">3. Get fit while having fun</span><br>
This is fitness that doesn't feel like a chore! Build physical endurance, improve agility and keep your energy levels high while doing something you enjoy!<br><br>

<span style="font-weight: bold;">4. Find your tribe</span><br>
Connect with people who share your passion for dance. Make new friends, support each other, and enjoy a positive, welcoming community.<br><br>

<span style="font-weight: bold;">5. Level up your personal growth</span><br>
Every battle and practice helps sharpen your rhythm, style, and stage presence. You're not just dancing, you're growing mentally, physically, and creatively.</p>

</div>


<div style="padding: 35px 0px 0px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><b>Join the Live Battle! Show Up and Own the Floor.</b>
  </p> 

  <p style="font-size: 16px; line-height: 26px; text-align: justify;">Sign up for Street Dance @ North West! Stand a chance to win top cash prizes.</p>
</div>

<div style="width: 100%;">
<div style="background: #842D2D; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: center; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 20px; font-weight: bold; font-family: Arial, 'sans-serif;'; text-transform: uppercase; letter-spacing: 5px;">
          <p style="font-weight: bold; color: #FFFFFF; margin: auto;">Choose your battle style</p>
  </div>
</div>

    <div style="padding: 0px 0px;" class="col-12">
      <div style="display: flex;" class="col-6">
        <div style="width: 100%;padding: 0px;">
        <div style="width: 100%; background: #FFD8D8;" class="">
          <div style="width: 98%; margin: 0px auto;">
            <div style="width: 100%; padding: 15px 15px 0px; display: table-cell;">
              <p style="font-size: 16px; line-height: 20px; margin: 10px 0px;">Go solo in the one-on-one showdown</p>
              <img style="width: 100%;" class="" src="/images/Cohesion/Mar%202026/1v1.gif">
              <p style="font-size: 16px; line-height: 20px; margin: 10px 0px 0px;">Open Style 1v1 (open to all)</p>
            </div>        
          </div>
        </div>
        </div>
      ...
      <div style="display: flex;" class="col-6">
        ...
        <div style="width: 100%; background: #FFD8D8;" class="">
          <div style="width: 98%; margin: 0px auto;">
            <div style="width: 100%; padding: 15px 15px 0px; display: table-cell;">
              <p style="font-size: 16px; line-height: 20px; margin: 10px 0px;">Bring a partner for the duo battle</p>
              <img style="width: 100%;" class="" src="/images/Cohesion/Mar%202026/2v2.gif">
              <p style="font-size: 16px; line-height: 20px; margin: 10px 0px 0px;">2v2 Open Styles Youth (&lt;35 years old)</p>
            </div>        
          </div>
        </div>
        </div>
...
<div style="background: #FFD8D8; margin: 30px 0px 0px; -webkit-border-bottom-right-radius: 10px;
...
<div style="padding: 0px; background: #FFFFFF; -webkit-border-bottom-right-radius: 20px;
-webkit-border-bottom-left-radius: 20px;
-moz-border-radius-bottomright: 20px;
-moz-border-radius-bottomleft: 20px;
border-bottom-right-radius: 20px;
border-bottom-left-radius: 20px; padding: 20px 0px;">



  <div class="rounded20" style="max-width: 100%; background: #F96B8D; padding: 10px 25px;">
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px; margin: 0px; color: #FFFFFF;"><em style="font-weight: normal; color: #FFFFFF;">More on this topic:</em></p>
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #FFFFFF;">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; color: #FFFFFF; font-size: 16px; line-height: 26px; font-weight: bold; color: #F96B8D; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/march-2025/street-dance/"><span style="text-decoration: underline; color: #FFFFFF;">Street Dance Battle: Empowering Youths Through Dance</span>
      </a>
    </p>
  </div>
</div>
