...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="/images/Cohesion/September%202025/title_giving.jpg">
</div>

<div style="max-width: 100%; padding: 30px 0px 10px;" class="rounded20">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/September%202025/giving1.jpg">
</div>

<div style="padding: 20px 0px 0px;">
<p style="font-size: 16px; line-height: 26px;">Seventeen years ago, a small group of passionate people came together with a big idea: if we all pitch in a little, together we can do so much more!
<br><br>
Fast forward to today and Club-100 @ North West has grown into a Giving Community that has become a force for good!
<br><br>
Each month, more than 700 members contribute to help less-privileged residents in our North West cope with the rising cost of living, handle unexpected household expenses or emergencies, or ease the financial strain of raising children.</p>
</div>

<div style="padding: 20px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <strong style="color: #D5262B;">Rolling up sleeves together</strong>
  </p>
</div>
...
<p style="font-size: 16px; line-height: 26px;">Every quarter, Club-100 members support North West Service Weeks at its Pop-Up Market to help needy families select and customise their care packs with food and household essentials.</p>
</div>

<div style="padding: 20px 0px 0px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color:#000000; margin: 0px 0px;">
    <strong style="color: #000000;">Hear about their experiences:</strong>
  </p>
</div>

<div style="width: 100%; padding: 0px 0px 0px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202025/giving2.jpg">
</div>

<div style="width: 100%; padding: 0px 0px 0px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202025/giving3.jpg">
</div>

<div style="width: 100%; padding: 0px 0px 20px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202025/giving4.jpg">
</div>
...
<div style="width: 100%; padding: 20px 0px 0px; text-align: center; display: flex;">
  <div style="width:100%; text-align: center; margin: auto;">
    <iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="800" width="500" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fweb.facebook.com%2Fnwcdc%2Fposts%2Fpfbid025rC3bpkDSqP8FXpDTdHibEuuzHJ6uckVLu3o5foQDwnHbu73Wj9BJVpLEpWMQGEXl&amp;show_text=true&amp;width=500"></iframe>
  </div>
</div>
...
<div style="width: 100%; padding: 20px 0px 20px; text-align: center; display: flex;">
  <div style="width:100%; text-align: center; margin: auto;">
    <iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="476" width="380" src="https://www.facebook.com/plugins/video.php?height=476&amp;href=https%3A%2F%2Fweb.facebook.com%2Fnwcdc%2Fvideos%2F1230447612214703%2F&amp;show_text=false&amp;width=380&amp;t=0"></iframe>
  </div>
</div>
...
<div style="background: #DA312C; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Giving just got easier!</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  ...
  <div class="w-100">
    <p style="font-size: 16px; line-height: 18px; padding: 10px 5px 15px; margin: 0px 0px;">
      For the first time, you can now donate to Club-100 @ North West through giving.sg!
<br><br>
All it takes is a few clicks to support #OurNorthWest Community!
<br><br>
Donate now at: <a style="font-weight: bold; color: #D5262B;" target="_new" href="https://go.gov.sg/nw-c100digital">https://go.gov.sg/nw-c100digital</a>
<br><br>
Find out more about Club-100 @ North West <a style="font-weight: bold; color: #D5262B;" target="_new" href="https://www.giving.sg/organisation/profile/northwestcdc">here</a>.
<br><br>
</p>
  </div>
  ...
  <div class="rounded20" style="max-width: 100%; background: #FDFDFE; padding: 10px 20px;">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #D5262B">
      &gt; &nbsp;<a target="new" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #D5262B; text-decoration: underline;" href="https://northwest.cdc.gov.sg/cohesion/september-2024/nw-charity-golf/"><span style="text-decoration: underline;">A Giving Community Gives Back</span>
      </a>
    </p>
  </div>
</div>
