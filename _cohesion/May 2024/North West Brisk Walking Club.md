...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="https://staging-lite.d2zr4mfri8ph9q.amplifyapp.com/images/Cohesion/May%202024/title_healthy.png">
</div>

<div class="rounded20" style="max-width: 100%; padding: 30px 0px 0px;">
  <img style="width: 100%;" src="https://staging-lite.d2zr4mfri8ph9q.amplifyapp.com/images/Cohesion/May%202024/kv_healthy.png">
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Mr Leng Tian Poh and Madam Ong Kwee Heong are the dynamic husband-and-wife duo leading the
North West Brisk Walking Club’s weekly expedition walks for Marsiling Zone 4. They received the North West WeCare Volunteer Award at the North West Volunteers’ Appreciation 2024 for their role as
 Healthy Living Champions.
<br><br>
The couple was recognised for their efforts to encourage an active lifestyle and foster closer community bonds. Through their dedication, the club has grown to over 100 members, providing an avenue for seniors and community members to connect through shared interests.
</p>
</div>

<div style="padding: 20px 0px 20px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong style="color: #F96B8D;">#KopiTalk with North West Healthy Living Champions</strong>
  </p>
</div>

<div class="rounded20" style="max-width: 100%; padding: 15px 0px 0px;">
  <img style="width: 100%;" src="https://staging-lite.d2zr4mfri8ph9q.amplifyapp.com/images/Cohesion/May%202024/mr_leng.png">
</div>

<div class="rounded20" style="max-width: 100%; padding: 30px 0px 0px;">
  <img style="width: 100%;" src="https://staging-lite.d2zr4mfri8ph9q.amplifyapp.com/images/Cohesion/May%202024/mdm_ong.png">
</div>

<div style="max-width: 100%; padding: 0px 34px 30px; background: #FEF2FD;-webkit-border-bottom-right-radius: 20px;
-webkit-border-bottom-left-radius: 20px;
-moz-border-radius-bottomright: 20px;
-moz-border-radius-bottomleft: 20px;
border-bottom-right-radius: 20px;
border-bottom-left-radius: 20px;">
  <img style="width: 100%; padding-top: 20px;" src="https://staging-lite.d2zr4mfri8ph9q.amplifyapp.com/images/Cohesion/May%202024/hl_quote.gif">
</div>
...
<div style="width: 100%; background: #EBDFEC; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #F96B8D; margin: 0px 0px;"><strong>Take charge of your fitness</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">Embrace an active lifestyle just like our North West Healthy Living Champions. Register your interest to join the North West Brisk Walking Club <a style="font-weight: bold; color: #F96B8D;" target="_new" href="https://form.gov.sg/647d8a160590a40012ff0128">here</a>. Let’s take that step towards a healthier lifestyle today!
      </p> 

      <div class="rounded20" style="max-width: 100%; padding: 20px 0px 20px;">
        <img style="width: 100%;" class="rounded20" src="https://northwest.cdc.gov.sg/images/Cohesion/November%202023/brisk-walking-kv.jpg">
      </div>
