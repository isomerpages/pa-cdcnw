...
permalink: /cohesion/january-2025/nw-hlc/
variant: markdown
description: ""
...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/January%202025/title_start_your_fitness.png">
</div>
...
<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/January%202025/healthy_schedule.jpg">
</div>
...
<div style="background: #F96B8D; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Become a Member of the North West Healthy Living Clubs</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  <div class="w-100">
    ...
    <p style="font-size: 16px; line-height: 26px; padding: 10px 5px; margin: 0px 0px;">Kickstart your fitness journey and join a buzzing community that's all about healthy living.
Sign up and take that leap towards a more active lifestyle.<br><br>
