...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="/images/Cohesion/January%202025/title_lets_build.png">
</div>

<div style="max-width: 100%; padding: 20px 0px 0px;" class="">
  <img style="width: 100%; margin-top: 0px;" class="" src="/images/Cohesion/January%202025/mayor_message_01.gif">
</div>

<div style="max-width: 100%; padding: 0px 0px; background-image: url('/images/Cohesion/January%202025/mayor_message.png'); background-size: cover; background-repeat: no-repeat; background-position: bottom; -webkit-border-bottom-right-radius: 20px;
-webkit-border-bottom-left-radius: 20px;
-moz-border-radius-bottomright: 20px;
-moz-border-radius-bottomleft: 20px;
border-bottom-right-radius: 20px;
border-bottom-left-radius: 20px;" class="">
  <div style="padding: 20px 20px;">

  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/MAIBx63xD8Y" height="315" width="560"></iframe>
  </div>

  <p style="font-size: 16px; line-height: 26px; text-align: center; max-width: 600px; margin: auto; padding: 20px 15px;">Relive 2024 as our Mayor takes us through those aura moments, showing how we're building a healthy and caring community while staying GOATED together. 
  <br><br>
Hit play to learn the slangs! Stay lit and keep glowing! ✨😉</p>
  </div>
</div>
...
<div style="width: 100%; background: #FB5C1F; border-radius: 30px; padding: 0px 0px; display: flex;">
  <div style="width: 100%; padding: 30px 10px 8px; text-align: center; margin: auto;">
    ...
    <div style="width: 100%; padding: 15px 10px; text-align: center;   display: flex; justify-content: center; align-items: center;">
      ...
      <a target="_new" href="https://www.linkedin.com/company/north-west-community-development-council/posts/?feedView=all" style="line-height: normal !important; margin-bottom: 0px !important;"><img style="padding: 0px 7px; max-width: 40px;" src="/images/Cohesion/January%202025/linkedin_white.png"></a>
