...
<div style="width: 100%;">
  <img style="width: 100%;" src="/images/Cohesion/January%202024/sustainable_communities.png">
  <img style="width: 100%;" src="/images/Cohesion/March%202024/title_build_farm.jpg">
</div>

<div class="rounded20" style="max-width: 100%; padding: 30px 0px 0px;">
  <img style="width: 100%;" src="/images/Cohesion/March%202024/kv_sustainable.png">
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Everyday, a group of dedicated volunteers turn up without fail to tend to the crops at “Our Very Own Farm”, as the Nee Soon East Community Farm is affectionately known. Located opposite Blk 320 Yishun Central, the community farm was built using recycled materials and has become a labour of love for the residents involved.<br><br>
Discover how the journey began, and how the community farm has rekindled the kampung spirit and brought sustainability to life!
</p>
</div>


<div style="max-width: 100%;">
  <img style="width: 100%;" class="" src="/images/Cohesion/March%202024/planting_seeds.png">
</div>
...
<div style="max-width: 100%;">
  <img style="width: 100%; margin-top: 30px;" class="rounded20" src="/images/Cohesion/March%202024/sustainable_quote_1.jpg">
</div>

<div style="max-width: 100%;">
   <img style="width: 100%; margin-top: 30px;" class="rounded20" src="/images/Cohesion/March%202024/sustainable_quote_2.jpg">
</div>

<div style="max-width: 100%;">
   <img style="width: 100%; margin-top: 30px;" class="rounded20" src="/images/Cohesion/March%202024/sustainable_quote_3.jpg">
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Be part of something green and exciting at our vibrant community farm! From eco-workshops to vegetable harvesting, there’s something for everyone!<br><br>

Here are some of things you can do to help us out:<br>

• Watering plants<br>
• Weeding<br>
• Pruning<br>
• Refilling water barrels<br>
• Building planter beds<br>
• Germinating<br>
• Planting seedlings<br>
...
<div class="carousel">
    <div class="carousel-inner" style="-webkit-border-radius: 20px; -moz-border-radius: 20px; border-radius: 20px;">
        ...
        <div class="carousel-item">
            <img src="/images/Cohesion/March%202024/slide1.jpg" style="width: 100%;">
        </div>
        <input class="carousel-open" type="radio" id="carousel-2" name="carousel" aria-hidden="true" hidden="">
        <div class="carousel-item">
            <img src="/images/Cohesion/March%202024/slide2.jpg" style="width: 100%;">
        </div>
        <input class="carousel-open" type="radio" id="carousel-3" name="carousel" aria-hidden="true" hidden="">
        <div class="carousel-item">
            <img src="/images/Cohesion/March%202024/slide3.jpg" style="width: 100%;">
        </div>
        <input class="carousel-open" type="radio" id="carousel-4" name="carousel" aria-hidden="true" hidden="">
        <div class="carousel-item">
            <img src="/images/Cohesion/March%202024/slide4.jpg" style="width: 100%;">
        </div>
...
<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Join us every 2nd Sunday of the month for our monthly farming workshop in collaboration with Ground Up Initiative! This is a fantastic opportunity for you to learn and actively participate in planting, weeding, harvesting and maintaining the farm! See you there!
</p>
</div>
