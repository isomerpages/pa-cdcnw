...
<div style="width: 100%;">
  <img style="width: 100%; max-width:" src="/images/Cohesion/January%202024/caring_communities.png">
  <img style="width: 100%; max-width:" src="/images/Cohesion/March%202024/title_giving_community.jpg">
</div>
...
<p style="font-size: 16px; line-height: 26px;">Club-100 @ North West is heading in a brand new direction! From 2024, it will support vulnerable residents with a wider range of urgent needs such as the higher cost of living, the financial strain of raising children, unforeseen but crucial household expenses, or emergency situations at home.<br><br>

Let’s meet Fiona Ng, who has chosen to make a difference through her consistent contributions.<br><br>

Fiona has always been passionate about supporting the community. Learning about her friend’s regular donations to Club-100 @ North West, she found out how the funds directly supported beneficiaries with essentials, as well as urgent needs.. This prompted her to sign up to be a member.</p>
</div>

<div class="" style="max-width: 100%; padding: 30px 0px 20px;">
  <img style="width: 100%; margin-top: 0px;" class="" src="/images/Cohesion/March%202024/fiona_quote_1.jpg">
</div>

<p style="font-size: 16px; line-height: 26px;">Fiona also volunteers her time to help the needy such as during the North West Service Weeks event in Woodgrove, a joint effort between the North West CDC and the SMU Business Family Group. She looks forward to supporting future Club-100 @ North West initiatives to care for the less-privileged in the community.</p>

<div class="" style="max-width: 100%; padding: 30px 0px 20px;">
  <img style="width: 100%; margin-top: 0px;" class="" src="/images/Cohesion/March%202024/fiona_quote_2.jpg">
</div>

<div class="" style="max-width: 100%; padding: 30px 0px 20px;">
  <img style="width: 100%; margin-top: 0px;" class="" src="/images/Cohesion/March%202024/club100_infographicsv2.jpg">
</div>
...
<div style="width: 100%; background: #F5E1E0; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #DA312C; margin: 0px 0px;"><strong>Be part of A Giving Community!</strong>
      </p> 
