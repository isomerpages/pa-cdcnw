...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/September%202024/title_skillsfuture.jpg">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%;" class="rounded20" src="/images/Cohesion/September%202024/sf_kv.gif">
</div>

<div style="padding: 20px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">SkillsFuture Festival @ North West offered a range of activities including workshops, free consultations with industry experts and walk-in interviews with potential employers. 
<br><br>
From fresh graduates to working adults looking for a mid-career switch, attendees had the opportunities to enhance their skills and connect with employers from different industries.
</p>
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; margin-left: -2px;" class="" src="/images/Cohesion/September%202024/learning_jouney.png">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%; margin-left: -2px;" class="" src="/images/Cohesion/September%202024/learning_claire_01.jpg">
</div>
<div class="" style="max-width: 100%; padding: 20px 0px; background: #F7F7F7; text-align: center;">
  <div style="max-width: 100%; padding: 0px 28px;">
    <div class="video-container rounded20">
      <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/48m6OZ6bYgw?si=7_GshEfLk6B-ZLP_" height="315" width="560"></iframe>
    </div>
  </div>
</div>
<div class="" style="max-width: 100%; padding: 0px 0px 0px;">
  <img style="width: 100%; margin-left: -2px;" class="" src="/images/Cohesion/September%202024/learning_claire_03.jpg">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/learning_3tips.png">
</div>
...
<div style="width: 100%; background: #DAF4FE; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      ...
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #1F4D7F; margin: 0px 0px;"><strong>Start your learning journey today! </strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 20px;">Join us in making lifelong learning a way of life by continuously growing your knowledge to achieve your professional and personal goals. 
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;"><a style="font-weight: bold; color: #1F4D7F;" target="_new" href="https://go.gov.sg/connectsfa">Register your interest</a> for upcoming SkillsFuture workshops and events and subscribe to our email list for updates on the latest upskilling resources. .
      </p> 
