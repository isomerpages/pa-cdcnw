...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" src="/images/Cohesion/September%202024/title_bootcamp2.jpg">
</div>
...
<div class="" style="max-width: 100%; padding: 30px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/measure_treasure_01.jpg">
</div>

<div class="" style="max-width: 100%; padding: 0px 0px 0px; background: #EBF4F2; border-left: 2px solid #AA7D00; border-right: 2px solid #AA7D00;">
  <div class="" style="max-width: 100%; padding: 0px 30px 10px;">
...
<div style="margin-top: 0px;" class="carousel">
    <div style="-webkit-border-radius: 20px; -moz-border-radius: 20px; border-radius: 20px;" class="carousel-inner">
        ...
        <div class="carousel-item">
            <img style="width: 100%;" src="/images/Cohesion/September%202024/mt3.png">
        </div>
        <input hidden="" aria-hidden="true" name="carousel" id="carousel-2" type="radio" class="carousel-open">
        <div class="carousel-item">
            <img style="width: 100%;" src="/images/Cohesion/September%202024/mt4.png">
        </div>
        <input hidden="" aria-hidden="true" name="carousel" id="carousel-3" type="radio" class="carousel-open">
        <div class="carousel-item">
            <img style="width: 100%;" src="/images/Cohesion/September%202024/mt5.png">
        </div>
...
<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/measure_treasure_03.jpg">
</div>
<div class="" style="max-width: 100%; padding: 0px 0px 0px; background: #EBF4F2; border-left: 2px solid #AA7D00; border-right: 2px solid #AA7D00;">
  <div class="" style="max-width: 100%; padding: 0px 30px 10px;">
    <img style="width: 100%;" class="rounded20" src="/images/Cohesion/September%202024/1st.gif">
  </div>
</div>
<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/measure_treasure_05.jpg">
</div>

<div class="" style="max-width: 100%; padding: 30px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/gbc_w2nd_01.jpg">
</div>
<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%; -webkit-border-top-left-radius: 20px; -webkit-border-top-right-radius: 20px; -moz-border-radius-topleft: 20px; -moz-border-radius-topright: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px;" class="" src="/images/Cohesion/September%202024/2nd.gif">
</div>
<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/gbc_w2nd_03.jpg">
</div>

<div class="" style="max-width: 100%; padding: 30px 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/gbc_w3rd_01.jpg">
</div>
<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%; -webkit-border-top-left-radius: 20px; -webkit-border-top-right-radius: 20px; -moz-border-radius-topleft: 20px; -moz-border-radius-topright: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px;" class="" src="/images/Cohesion/September%202024/2nd.gif">
</div>
<div class="" style="max-width: 100%; padding: 0px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/September%202024/gbc_w3rd_03.jpg">
</div>

<div style="padding: 30px 0px 0px;">
  <p style="font-size: 20px; font-weight: bold; text-align: left; color: #086B37; margin: 0px 0px;"><strong>Catch the Highlights from Green Bootcamp @ North West 2024</strong></p> 
</div>
...
<div style="width: 100%; background: #DCEAE3; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 40px 40px;">
    ...
    padding-right: 50px;"><strong>Join the movement for a greener future </strong>
      ...
      <br><br>
Or immerse in an interactive food journey and experience green activities at our North West Sustainability Festival 2024, happening on 8 to 10 November at the outdoor plaza beside Hillion Mall! More details <a style="font-weight: bold; color: #086B37;" target="_new" href="https://go.gov.sg/nw-sustfest">here</a>! 
