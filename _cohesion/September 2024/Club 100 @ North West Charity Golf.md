...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="/images/Cohesion/September%202024/title_club100.jpg">
</div>

<div style="padding: 10px 0px 0px;">
<p style="font-size: 16px; line-height: 26px;">Whether it is golfing or participating in our dinner, the generosity of our Giving Community shines through and raised over $600,000 to support less-privileged residents living in #ourNorthWest.</p>
</div>

<div style="max-width: 100%; padding: 20px 0px 10px;" class="rounded20">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/September%202024/club100_kv.gif">
</div>

<div style="padding: 20px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <strong style="color: #D5262B;">Meet our top donors </strong>
  </p>
</div>

<div style="padding: 0px 0px 0px;">
<p style="font-size: 16px; line-height: 26px;">The contributions from our Platinum Donors played a big part in making this possible. Find how what fuel their motivation to take action and make a difference to the community!</p>
</div>

<div style="width: 100%; padding: 20px 0px 20px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202024/donor_q1.jpg">
</div>

<div style="width: 100%; padding: 20px 0px 20px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202024/donor_q2.jpg">
</div>

<div style="width: 100%; padding: 20px 0px 20px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202024/donor_q3.jpg">
</div>

<div style="width: 100%; padding: 20px 0px 20px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202024/donor_q4.jpg">
</div>

<div style="width: 100%; padding: 20px 0px 20px;">
  <img style="width: 100%; max-width:" class="rounded20" src="/images/Cohesion/September%202024/donor_q5.jpg">
</div>

<div style="padding: 20px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <strong style="color: #D5262B;">Be part of a Giving Community</strong>
  </p>
</div>

<div style="padding: 0px 0px 0px;">
<p style="font-size: 16px; line-height: 26px;">By joining Club-100 @ North West, you will make a difference to the lives of less-privileged residents living in #ourNorthWest. Hear how Sharon, a beneficiary of Club-100 @ North West, has benefitted from the programme.</p>
</div>

<div style="max-width: 100%; padding: 30px 0px;">
  <div class="video-container rounded20">
    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/rC43L_Y-JE8?si=85GqAzLDdv0yewNX" height="315" width="560"></iframe>
  </div>
</div>
...
<div style="width: 100%; background: #F5E1E0; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #DA312C; margin: 0px 0px;"><strong>Join Club-100 @ North West today!</strong>
      </p> 

      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px 0px;">Pledge to contribute at least $100 every month to uplift the lives of less-privileged residents in our&nbsp;community!<br><br>

Sign up for Club-100 @ North West through this donation form, or email  <a style="font-weight: bold; color: #D5262B;" target="_new" href="mailto:northwestcdc_partnerships@pa.gov.sg">northwestcdc_partnerships@pa.gov.sg</a> for more information.
