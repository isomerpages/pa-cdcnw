...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="/images/Cohesion/September%202024/title_cdcv.jpg">
</div>

<div style="padding: 10px 0px 0px;">
<p style="font-size: 16px; line-height: 26px;">With a total of $800 worth CDC vouchers disbursed this year, the CDC Vouchers Scheme provides immediate relief to help residents defray household expenses, as well as encourages them to support hawkers and businesses in the heartlands. 
<br><br>
Find out how two North West residents plan to spend their CDC vouchers. </p>
</div>

<div style="max-width: 100%; padding: 20px 0px 10px;" class="rounded20">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/September%202024/lighten_ong.jpg">
</div>

<div style="max-width: 100%; padding: 20px 0px 10px;" class="rounded20">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/September%202024/lighten_tracy.jpg">
</div>

<div style="max-width: 100%; padding: 20px 0px 10px;" class="rounded20">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="/images/Cohesion/September%202024/dyk.jpg">
</div>

<div style="max-width: 100%; padding: 20px 0px 0px;" class="rounded20">
  <a target="_new" href="https://go.gov.sg/cdcvouchers">
  <img style="width: 100%; margin-top: 0px;" class="" src="/images/Cohesion/September%202024/lighten_infographics_01.jpg">
  </a>
</div>

<div style="max-width: 100%; padding: 0px 0px 20px;" class="rounded20">
  <a target="_new" href="https://vouchers.cdc.gov.sg">
    <img style="width: 100%; margin-top: 0px;" class="" src="/images/Cohesion/September%202024/lighten_infographics_02.jpg">
  </a>
</div>
...
<div style="padding: 20px 0px 0px;">
  <p style="font-size: 24px; font-weight: bold; text-align: left; color:#D5262B; margin: 0px 0px;">
    <strong style="color: #D5262B;">Check out the upcoming government support initiatives for the second half of the year to ease the cost of living. </strong>
  </p>
</div>

<div style="padding: 30px 0px 0px; text-align: center;">
<iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="635" width="500" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FMOFsg%2Fposts%2Fpfbid06AzQG1rQriwz1GErzvy45LffAs1oURaEBCLD9nTYEa7cxbBaqrDTC9Bk5wnitYmgl&amp;show_text=true&amp;width=500"></iframe>
</div>
