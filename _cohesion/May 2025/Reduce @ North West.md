...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" alt="" src="/images/Cohesion/May%202025/title_spreading_awareness.png">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 10px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/kv_spreading_awareness.jpg">
</div>

<div style="padding: 10px 0px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">What happens when students go door to door to spread the word on sustainability? They amplify the green impact, educate residents on green living, and build up their confidence.</p>

<p style="font-size: 16px; line-height: 26px; text-align: justify;">In March, a group of Secondary 4 students from Hwa Chong Institution (HCI) went on an outreach mission to educate residents in Clementi on Reduce @ North West and share tips on how to reduce household energy and water consumption.</p>

<p style="font-size: 16px; line-height: 26px; text-align: justify;">Besides raising awareness on sustainability, the initiative also helps to nurture active citizens – people who care, speak up, and take action for a greener future. HCI Secondary 4 students See Lin Yi and Li JinFeng share how the day went down.
</p>
</div>


<div class="" style="max-width: 100%; padding: 20px 0px 10px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/see_lin_yi_01.gif">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/see_lin_yi_02.jpg">
</div>

<div class="" style="max-width: 100%; padding: 20px 0px 10px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/li_jenfeng_01.jpg">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/li_jenfeng_02.gif">
</div>
...
<div style="background: #196C37; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
        <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Do more for the planet now!</strong>
        </div>
</div>
...
border-bottom-left-radius: 20px;">
  <div class="w-100">
      ...
      <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 0px 5px 15px;">Join the Reduce @ North West challenge to play your part in saving the environment. Open to North West residents, all you need to do is to make small changes to everyday habits so you can reduce your electricity and water consumption. <a style="font-weight: bold; color: #086B37;" target="_new" href="https://go.gov.sg/reduce-sign-up">Sign up now</a>.
      </p> 

  </div>

  <div style="max-width: 100%; background: #EAF3EE; padding: 10px 20px;" class="rounded20">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px;">
      &gt; &nbsp;<a href="https://northwest.cdc.gov.sg/cohesion/january-2025/reduce-nw/" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #0C6C37; text-decoration: underline;" target="new"><span style="text-decoration: underline;">Take the Pledge to Lower Your Energy or Water Bills!</span>
      </a>
    </p>
  </div>
</div>
