...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" alt="" src="/images/Cohesion/May%202025/title_secret_mental_awarenss.png">
</div>


<div style="padding: 20px 0px 20px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Active ageing isn't just about staying physically fit – it's about keeping the mind sharp too! Engaging in cognitive activities can boost memory, focus, and overall mental wellness, making it a vital part of ageing well.
<br><br>
In November 2024, two active ageing centres in Yishun – All Saints Home and St Luke's ElderCare – teamed up to organise a friendly mahjong and Rummikub competition. The aim? To help seniors stay mentally active! There were no treadmills or weights at this first-ever Inter-Centre Cognitive Games Competition, but make no mistake – minds were getting a full workout indeed!</p>
</div>

<div class="" style="max-width: 100%; padding: 10px 0px 40px; text-align: center;">
<iframe allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden" height="831" width="500" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FASHome.sg%2Fposts%2Fpfbid0XRxPXmviZ28M1Dyky7PfKcc5R9AiTeqQNbEKzM7MqZFXBHM99RGqXsw2NRYUfVt5l&amp;show_text=true&amp;width=500"></iframe>
</div>

<div class="" style="max-width: 100%; padding: 20px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/champion_edmund.jpg">
</div>

<div class="" style="max-width: 100%; padding: 10px 0px ;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/champion_madam_lee.jpg">
</div>
...
<div class="" style="max-width: 100%; padding: 15px 0px;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/infographics_10_brain_games.jpg">
</div>
...
<div style="background: #F96B8D; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Boost Your Mental Wellness with Mental Wellness @ North West</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  <div class="w-100">
    ...
    <p style="font-size: 16px; line-height: 26px; padding: 10px 5px 15px; margin: 0px 0px;">Mental Wellness @ North West is a programme that aims to raise awareness about mental wellness in the community by building up a mental wellness support network. In 2023, the programme expanded to include Mental Wellness Ambassadors within all divisions who will provide support to the community, drive mental wellness initiatives and help residents, including seniors, get access to mental health services early.
      <br><br>
    <a style="font-weight: bold; color: #F96B8D; text-decoration: underline;" target="_new" href="https://northwest.cdc.gov.sg/programmes/promoting-health-and-wellness/mental-wellness/">Find out more</a> about Mental Wellness @ North West
    </p>
  ...
  <div style="max-width: 100%; background: #FDE7FC; padding: 10px 20px;" class="rounded20">
    ...
    <p style="font-size: 16px; line-height: 26px; text-align: justify; padding: 0px 0px 5px; margin: 0px; color: #E66776;">
      &gt; &nbsp;<a href="https://northwest.cdc.gov.sg/cohesion/march-2023/mental-wellness-nw/" style="font-family: 'Lato', sans-serif; font-size: 16px; line-height: 26px; font-weight: bold; color: #E66776; text-decoration: underline;" target="new"><span style="text-decoration: underline;">6 Essential Tips for Better Mental Wellness</span>
      </a>
    </p>
  </div>

<p style="font-size: 16px; line-height: 26px; padding: 15px 5px 10px; margin: 0px 0px;">Besides keeping mentally active, seniors can also explore these 4 senior-friendly Healthy Living Clubs in the North West, all designed for fun and health!</p>

<p style="font-size: 20px; font-weight: bold; text-align: left; color: #FF5C83; margin: 10px 0px;">Get moving with North West Healthy Living Clubs</p>

    <div style="width: 100%; display: flex; border-bottom: thin solid #acacac; padding: 0px 0px 25px;" class="col-12">
      <div style="margin: auto; text-align: center;" class="col-3 float-left">
        <img style="max-width: 110px; width: 100%; padding: 10px 20px; vertical-align: middle;" src="/images/Cohesion/May%202025/logo_qigong.png">
      </div>
      <div style="margin: auto;" class="col-9 float-left">
        <p style="font-weight: bold; font-size: 18px; line-height: 20px; margin: 0px; width: 100%;">North West Health Qigong Club </p>
        <p style="font-size: 16px; font-style: italic; line-height: 20px; margin: 0px;">Best for: Those who enjoy gentle movements with deep breathing to feel more centred</p>
      </div>
    </div>

    <div style="width: 100%; display: flex; border-bottom: thin solid #acacac; padding: 25px 0px;" class="col-12">
      <div style="margin: auto; text-align: center;" class="col-3 float-left">
        <img style="max-width: 70px; width: 100%; padding: 10px 20px; vertical-align: middle;" src="/images/Cohesion/May%202025/logo_taichi.png">
      </div>
      <div style="margin: auto;" class="col-9 float-left">
        <p style="font-weight: bold; font-size: 18px; line-height: 20px; margin: 0px; width: 100%;">North West Tai Chi Club</p>
        <p style="font-size: 16px; font-style: italic; line-height: 20px; margin: 0px;">Best for: Those who prefer slow and flowing movements to build strength and balance</p>
      </div>
    </div>

    <div style="width: 100%; display: flex; border-bottom: thin solid #acacac; padding: 25px 0px;" class="col-12">
      <div style="margin: auto; text-align: center;" class="col-3 float-left">
        <img style="max-width: 110px; width: 100%; padding: 10px 20px; vertical-align: middle;" src="/images/Cohesion/May%202025/logo_briskwalk.png">
      </div>
      <div style="margin: auto;" class="col-9 float-left">
        <p style="font-weight: bold; font-size: 18px; line-height: 20px; margin: 0px; width: 100%;">North West Brisk Walking Club</p>
        <p style="font-size: 16px; font-style: italic; line-height: 20px; margin: 0px;">Best for: Those looking for a simple, energising exercise that keeps the body active and engaged</p>
      </div>
    </div>

    <div style="width: 100%; display: flex; border-bottom: thin solid #acacac; padding: 25px 0px;" class="col-12">
      <div style="margin: auto; text-align: center;" class="col-3 float-left">
        <img style="max-width: 110px; width: 100%; padding: 10px 20px; vertical-align: middle;" src="/images/Cohesion/March%202025/logo_dancefit.png">
      </div>
      <div style="margin: auto;" class="col-9 float-left">
        <p style="font-weight: bold; font-size: 18px; line-height: 20px; margin: 0px; width: 100%;">North West Dance-Fit Club</p>
        <p style="font-size: 16px; font-style: italic; line-height: 20px; margin: 0px;">Best for: Those who enjoy simple dance routines while bopping to nostalgic tunes</p>
      </div>
    </div>

    <p style="font-size: 16px; line-height: 26px; padding: 20px 5px; margin: 0px 0px;">
      Register your interest <a style="font-weight: bold; color: #F96B8D; text-decoration: underline;" target="_new" href="https://form.gov.sg/647d8a160590a40012ff0128">here</a>.
    </p>
