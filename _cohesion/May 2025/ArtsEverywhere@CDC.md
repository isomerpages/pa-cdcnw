...
<div style="width: 100%;">
  ...
  <img style="width: 100%;" alt="" src="/images/Cohesion/May%202025/title_bigger_better.png">
</div>


<div style="padding: 20px 0px 20px;">
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Part of SG60 celebrations, ArtsEverywhere@CDC is back with more cultural performances, interactive fringe activities, and community bonding for everyone!
<br><br>
...
<div class="" style="max-width: 100%; padding: 0px 0px;">
  <a target="_new" href="https://go.gov.sg/artseverywhere-cdc">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/artseverywhere_01.jpg">
  </a>
</div>

<div class="" style="max-width: 100%; padding: 0px 0px; background: url('/images/Cohesion/May%202025/artseverywhere_02.jpg') top center; background-size: cover;">
  <p style="font-size: 22px; line-height: 26px; text-align: center; font-weight: bold; padding: 0px 10%; margin: 0px; color: #C10015;">Recap: The Kampung Spirit Comes Alive</p>

<div class="" style="max-width: 100%; padding: 20px 0px; text-align: center;">
  <div style="padding: 0px 10px;" class="iframe-wrapper">
    <iframe src="https://www.youtube.com/embed/vYF92AsjYlA" frameborder="0" allowfullscreen="true" height="711" width="400"></iframe>
  </div>
</div>

  <p style="font-size: 16px; line-height: 26px; text-align: left; padding: 25px 15% 50px; margin: 0px;"><span style="font-weight: bold;">What:</span> My Heritage: Kampong Life Gotong Royong by Sri Warisan Som Said Performing&nbsp;Arts<br>
  <span style="font-weight: bold;">When:</span> 13 April 2025<br>
  <span style="font-weight: bold;">Where:</span> Canberra Park</p>
</div>
...
<p style="font-size: 16px; line-height: 26px; text-align: justify;">Our residents had front-row seats to experience the Malay culture and heritage, transporting them back to the good old kampong days - where life was all about gotong-royong (mutual cooperation) and community spirit.
<br><br>
From the graceful flow of the warisan seni to the lively rhythim of zapin, each Malay dance tells its own unique story through movement and rhythm.</p>
</div>


<div style="padding: 10px 0px 10px;">
<p style="font-size: 22px; font-weight: bold; text-align: left; color: #B25694; margin: 10px 0px 0px;">Cultural exposure, made approachable</p>
</div>

<div class="" style="max-width: 100%; padding: 0px 0px ;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/quote_ezabelle.jpg">
</div>

<div style="padding: 30px 0px 10px;">
<p style="font-size: 22px; font-weight: bold; text-align: left; color: #B25694; margin: 10px 0px 0px;">Perfect for bonding and passing time together</p>
</div>

<div class="" style="max-width: 100%; padding: 0px 0px ;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/quote_kelvin.jpg">
</div>

<div style="padding: 30px 0px 10px;">
<p style="font-size: 22px; font-weight: bold; text-align: left; color: #B25694; margin: 10px 0px 0px;">It supports local artists and keeps the scene alive</p>
</div>

<div class="" style="max-width: 100%; padding: 0px 0px ;">
  <img style="width: 100%;" class="" src="/images/Cohesion/May%202025/quote_rifdec.jpg">
</div>
...
<div style="background: #B25694; margin: 30px 0px 0px; -webkit-border-top-left-radius: 25px; -webkit-border-top-right-radius: 25px; -moz-border-radius-topleft: 25px; -moz-border-radius-topright: 25px; border-top-left-radius: 25px; border-top-right-radius: 25px;">
  <div style="text-align: left; display: flex; margin: 0px auto; padding: 20px 35px 18px; color: #FFFFFF; font-size: 18px; font-weight: bold; font-family: Arial, 'sans-serif;';">
          <strong style="font-weight: bold; color: #FFFFFF;">Be part of the next performance – register for free today!</strong>
  </div>
</div>
...
border-bottom-left-radius: 20px;">
  <div class="w-100">
    ...
    <p style="font-size: 16px; line-height: 26px; padding: 10px 5px 15px; margin: 0px 0px;">Don't miss your chance to experience another enjoyable ArtsEverywhere@CDC performance. 
No expensive tickets, just free cultural arts performances and enjoyable company. 
Register your interest <a style="font-weight: bold; color: #B25694; text-decoration: underline;" target="_new" href="https://go.gov.sg/nw-ae-registration">here</a> and receive a game card to redeem a free snack!</p>
